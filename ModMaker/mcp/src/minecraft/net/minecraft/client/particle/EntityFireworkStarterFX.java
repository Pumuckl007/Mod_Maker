    ...
    public EntityFireworkStarterFX(World p_i1208_1_, double p_i1208_2_, double p_i1208_4_, double p_i1208_6_, double p_i1208_8_, double p_i1208_10_, double p_i1208_12_, EffectRenderer p_i1208_14_, NBTTagCompound p_i1208_15_)
    {
        ...
        if (p_i1208_15_ != null)
        {
            ...
            else
            {
                ...
                {
                    NBTTagCompound nbttagcompound1 = (NBTTagCompound)this.field_92039_az.func_74743_b(i);
    ...
    public void func_70071_h_()
    {
        ...
        if (this.field_92042_ax == 0 && this.field_92039_az != null)
        {
            ...
            else
            {
                for (int i = 0; i < this.field_92039_az.func_74745_c(); ++i)
                {
                    NBTTagCompound nbttagcompound = (NBTTagCompound)this.field_92039_az.func_74743_b(i);
            ...
            this.field_70170_p.func_72980_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, s, 20.0F, 0.95F + this.field_70146_Z.nextFloat() * 0.1F, true);
        }
        ...
        if (this.field_92042_ax % 2 == 0 && this.field_92039_az != null && this.field_92042_ax / 2 < this.field_92039_az.func_74745_c())
        {
            ...
            NBTTagCompound nbttagcompound1 = (NBTTagCompound)this.field_92039_az.func_74743_b(j);
            byte b0 = nbttagcompound1.func_74771_c("Type");
            boolean flag2 = nbttagcompound1.func_74767_n("Trail");
            boolean flag3 = nbttagcompound1.func_74767_n("Flicker");
        ...
        if (this.field_92042_ax > this.field_70547_e)
        {
            if (this.field_92041_a)
            {
                ...
                this.field_70170_p.func_72980_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, s1, 20.0F, 0.9F + this.field_70146_Z.nextFloat() * 0.15F, true);
            }
