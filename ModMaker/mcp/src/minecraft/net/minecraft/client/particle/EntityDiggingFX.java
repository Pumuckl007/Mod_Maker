...
public class EntityDiggingFX extends EntityFX
{
    ...
    public EntityDiggingFX func_70596_a(int p_70596_1_, int p_70596_2_, int p_70596_3_)
    {
        ...
        {
            int l = this.field_70597_a.func_71920_b(this.field_70170_p, p_70596_1_, p_70596_2_, p_70596_3_);
    ...
    public EntityDiggingFX func_90019_g(int p_90019_1_)
    {
        ...
        {
            int j = this.field_70597_a.func_71889_f_(p_90019_1_);
    ...
    public void func_70539_a(Tessellator p_70539_1_, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_, float p_70539_7_)
    {
        ...
        float f14 = 1.0F;
        p_70539_1_.func_78386_a(f14 * this.field_70552_h, f14 * this.field_70553_i, f14 * this.field_70551_j);
