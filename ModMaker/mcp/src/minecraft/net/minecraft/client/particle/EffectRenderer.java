...
public class EffectRenderer
{
    ...
    public void func_78868_a()
    {
        for (int i = 0; i < 4; ++i)
        {
            ...
            {
                EntityFX entityfx = (EntityFX)this.field_78876_b[i].get(j);
        ...
        if (p_78871_4_ != 0)
        {
            ...
            for (int j1 = 0; j1 < b0; ++j1)
            {
                for (int k1 = 0; k1 < b0; ++k1)
                {
                    ...
                    {
                        double d0 = (double)p_78871_1_ + ((double)j1 + 0.5D) / (double)b0;
                        double d1 = (double)p_78871_2_ + ((double)k1 + 0.5D) / (double)b0;
                        double d2 = (double)p_78871_3_ + ((double)l1 + 0.5D) / (double)b0;
                        this.func_78873_a((new EntityDiggingFX(this.field_78878_a, d0, d1, d2, d0 - (double)p_78871_1_ - 0.5D, d1 - (double)p_78871_2_ - 0.5D, d2 - (double)p_78871_3_ - 0.5D, block, p_78871_5_)).func_70596_a(p_78871_1_, p_78871_2_, p_78871_3_));
                    }
                }
            }
        }
    ...
    {
        int i1 = this.field_78878_a.func_72798_a(p_78867_1_, p_78867_2_, p_78867_3_);

        if (i1 != 0)
        {
            Block block = Block.field_71973_m[i1];
            float f = 0.1F;
            double d0 = (double)p_78867_1_ + this.field_78875_d.nextDouble() * (block.func_83007_w() - block.func_83009_v() - (double)(f * 2.0F)) + (double)f + block.func_83009_v();
            double d1 = (double)p_78867_2_ + this.field_78875_d.nextDouble() * (block.func_83010_y() - block.func_83008_x() - (double)(f * 2.0F)) + (double)f + block.func_83008_x();
            double d2 = (double)p_78867_3_ + this.field_78875_d.nextDouble() * (block.func_83006_A() - block.func_83005_z() - (double)(f * 2.0F)) + (double)f + block.func_83005_z();

            if (p_78867_4_ == 0)
            {
                d1 = (double)p_78867_2_ + block.func_83008_x() - (double)f;
            }

            if (p_78867_4_ == 1)
            {
                d1 = (double)p_78867_2_ + block.func_83010_y() + (double)f;
            }

            if (p_78867_4_ == 2)
            {
                d2 = (double)p_78867_3_ + block.func_83005_z() - (double)f;
            }

            if (p_78867_4_ == 3)
            {
                d2 = (double)p_78867_3_ + block.func_83006_A() + (double)f;
            }

            if (p_78867_4_ == 4)
            {
                d0 = (double)p_78867_1_ + block.func_83009_v() - (double)f;
            }

            if (p_78867_4_ == 5)
            {
                d0 = (double)p_78867_1_ + block.func_83007_w() + (double)f;
            }
