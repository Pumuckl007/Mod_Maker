...
public class ActiveRenderInfo
{
    ...
    public static Vec3 func_74585_b(EntityLivingBase p_74585_0_, double p_74585_1_)
    {
        ...
        return p_74585_0_.field_70170_p.func_82732_R().func_72345_a(d4, d5, d6);
    }

    public static int func_74584_a(World p_74584_0_, EntityLivingBase p_74584_1_, float p_74584_2_)
    {
        Vec3 vec3 = func_74585_b(p_74584_1_, (double)p_74584_2_);
        ...
        {
            float f1 = BlockFluid.func_72199_d(p_74584_0_.func_72805_g(chunkposition.field_76930_a, chunkposition.field_76928_b, chunkposition.field_76929_c)) - 0.11111111F;
            float f2 = (float)(chunkposition.field_76928_b + 1) - f1;
