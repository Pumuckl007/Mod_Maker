...
public class RenderWither extends RenderLiving
{
    ...
    {
        int i = p_110911_1_.func_82212_n();
    ...
    {
        int i = p_82415_1_.func_82212_n();

        if (i > 0)
        {
            float f1 = 2.0F - ((float)i - p_82415_2_) / 220.0F * 0.5F;
    ...
    protected int func_82417_a(EntityWither p_82417_1_, int p_82417_2_, float p_82417_3_)
    {
        if (p_82417_1_.func_82205_o())
        {
            ...
            if (p_82417_2_ == 1)
            {
                float f1 = (float)p_82417_1_.field_70173_aa + p_82417_3_;
