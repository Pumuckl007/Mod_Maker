...
public class EntitySorter implements Comparator
{
    ...
    {
        double d0 = (double)p_78946_1_.field_78925_n + this.field_78949_a;
        double d1 = (double)p_78946_1_.field_78926_o + this.field_78947_b;
        double d2 = (double)p_78946_1_.field_78940_p + this.field_78948_c;
        double d3 = (double)p_78946_2_.field_78925_n + this.field_78949_a;
        double d4 = (double)p_78946_2_.field_78926_o + this.field_78947_b;
        double d5 = (double)p_78946_2_.field_78940_p + this.field_78948_c;
