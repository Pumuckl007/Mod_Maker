...
public class TileEntityRenderer
{
    ...
    private TileEntityRenderer()
    {
        ...
        Iterator iterator = this.field_76966_m.values().iterator();

        while (iterator.hasNext())
        {
            TileEntitySpecialRenderer tileentityspecialrenderer = (TileEntitySpecialRenderer)iterator.next();
            tileentityspecialrenderer.func_76893_a(this);
        }
    }

    public TileEntitySpecialRenderer func_76951_a(Class p_76951_1_)
    {
        TileEntitySpecialRenderer tileentityspecialrenderer = (TileEntitySpecialRenderer)this.field_76966_m.get(p_76951_1_);

        if (tileentityspecialrenderer == null && p_76951_1_ != TileEntity.class)
        {
            tileentityspecialrenderer = this.func_76951_a(p_76951_1_.getSuperclass());
            this.field_76966_m.put(p_76951_1_, tileentityspecialrenderer);
        }
    ...
    public void func_76950_a(TileEntity p_76950_1_, float p_76950_2_)
    {
        ...
        {
            int i = this.field_76957_f.func_72802_i(p_76950_1_.field_70329_l, p_76950_1_.field_70330_m, p_76950_1_.field_70327_n, 0);
            int j = i % 65536;
            int k = i / 65536;
    ...
    {
        TileEntitySpecialRenderer tileentityspecialrenderer = this.func_76956_b(p_76949_1_);
        ...
        if (tileentityspecialrenderer != null)
        {
            ...
            catch (Throwable throwable)
            {
                ...
                CrashReportCategory crashreportcategory = crashreport.func_85058_a("Tile Entity Details");
                p_76949_1_.func_85027_a(crashreportcategory);
