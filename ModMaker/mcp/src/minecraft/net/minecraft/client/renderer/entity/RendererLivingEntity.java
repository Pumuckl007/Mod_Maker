...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void func_130000_a(EntityLivingBase p_130000_1_, double p_130000_2_, double p_130000_4_, double p_130000_6_, float p_130000_8_, float p_130000_9_)
    {
        ...
        try
        {
            float f2 = this.func_77034_a(p_130000_1_.field_70760_ar, p_130000_1_.field_70761_aq, p_130000_9_);
            float f3 = this.func_77034_a(p_130000_1_.field_70758_at, p_130000_1_.field_70759_as, p_130000_9_);
            float f4;

            if (p_130000_1_.func_70115_ae() && p_130000_1_.field_70154_o instanceof EntityLivingBase)
            {
                EntityLivingBase entitylivingbase1 = (EntityLivingBase)p_130000_1_.field_70154_o;
                f2 = this.func_77034_a(entitylivingbase1.field_70760_ar, entitylivingbase1.field_70761_aq, p_130000_9_);
            ...
            float f5 = p_130000_1_.field_70127_C + (p_130000_1_.field_70125_A - p_130000_1_.field_70127_C) * p_130000_9_;
            this.func_77039_a(p_130000_1_, p_130000_2_, p_130000_4_, p_130000_6_);
            f4 = this.func_77044_a(p_130000_1_, p_130000_9_);
            this.func_77043_a(p_130000_1_, f4, f2, p_130000_9_);
            float f6 = 0.0625F;
            GL11.glEnable(GL12.GL_RESCALE_NORMAL);
            GL11.glScalef(-1.0F, -1.0F, 1.0F);
            this.func_77041_b(p_130000_1_, p_130000_9_);
            GL11.glTranslatef(0.0F, -24.0F * f6 - 0.0078125F, 0.0F);
            float f7 = p_130000_1_.field_70722_aY + (p_130000_1_.field_70721_aZ - p_130000_1_.field_70722_aY) * p_130000_9_;
            float f8 = p_130000_1_.field_70754_ba - p_130000_1_.field_70721_aZ * (1.0F - p_130000_9_);
            ...
            this.field_77045_g.func_78086_a(p_130000_1_, f8, f7, p_130000_9_);
            this.func_77036_a(p_130000_1_, f8, f7, f4, f3 - f2, f5, f6);
            float f9;
            int i;
            float f10;
            float f11;
            ...
            for (int j = 0; j < 4; ++j)
            {
                i = this.func_77032_a(p_130000_1_, j, p_130000_9_);

                if (i > 0)
                {
                    this.field_77046_h.func_78086_a(p_130000_1_, f8, f7, p_130000_9_);
                    this.field_77046_h.func_78088_a(p_130000_1_, f8, f7, f4, f3 - f2, f5, f6);

                    if ((i & 240) == 16)
                    {
                        this.func_82408_c(p_130000_1_, j, p_130000_9_);
                        this.field_77046_h.func_78088_a(p_130000_1_, f8, f7, f4, f3 - f2, f5, f6);
                    }

                    if ((i & 15) == 15)
                    {
                        f9 = (float)p_130000_1_.field_70173_aa + p_130000_9_;
            ...
            float f14 = p_130000_1_.func_70013_c(p_130000_9_);
            i = this.func_77030_a(p_130000_1_, f14, p_130000_9_);
            OpenGlHelper.func_77473_a(OpenGlHelper.field_77476_b);
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            OpenGlHelper.func_77473_a(OpenGlHelper.field_77478_a);

            if ((i >> 24 & 255) > 0 || p_130000_1_.field_70737_aN > 0 || p_130000_1_.field_70725_aQ > 0)
            {
                GL11.glDisable(GL11.GL_TEXTURE_2D);
                ...
                if (p_130000_1_.field_70737_aN > 0 || p_130000_1_.field_70725_aQ > 0)
                {
                    ...
                    this.field_77045_g.func_78088_a(p_130000_1_, f8, f7, f4, f3 - f2, f5, f6);

                    for (int l = 0; l < 4; ++l)
                    {
                        if (this.func_77035_b(p_130000_1_, l, p_130000_9_) >= 0)
                        {
                            GL11.glColor4f(f14, 0.0F, 0.0F, 0.4F);
                            this.field_77046_h.func_78088_a(p_130000_1_, f8, f7, f4, f3 - f2, f5, f6);
                        }
                ...
                if ((i >> 24 & 255) > 0)
                {
                    ...
                    {
                        if (this.func_77035_b(p_130000_1_, i1, p_130000_9_) >= 0)
                        {
                            GL11.glColor4f(f9, f10, f15, f11);
                            this.field_77046_h.func_78088_a(p_130000_1_, f8, f7, f4, f3 - f2, f5, f6);
                        }
    ...
    protected void func_77043_a(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
        ...
        {
            String s = EnumChatFormatting.func_110646_a(p_77043_1_.func_70023_ak());
    ...
    protected void func_85093_e(EntityLivingBase p_85093_1_, float p_85093_2_)
    {
        ...
        if (i > 0)
        {
            ...
            Random random = new Random((long)p_85093_1_.field_70157_k);
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                double d2 = 0.0D;
                float f8 = 0.0F;
                this.field_76990_c.func_78719_a(entityarrow, d0, d1, d2, f8, p_85093_2_);
                GL11.glPopMatrix();
            }
    ...
    protected void func_77033_b(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_)
    {
        if (this.func_110813_b(p_77033_1_))
        {
            ...
            if (d3 < (double)(f2 * f2))
            {
                String s = p_77033_1_.func_96090_ax();
    ...
    {
        double d3 = p_77038_1_.func_70068_e(this.field_76990_c.field_78734_h);

        if (d3 <= (double)(p_77038_9_ * p_77038_9_))
        {
            FontRenderer fontrenderer = this.func_76983_a();
            float f = 1.6F;
            float f1 = 0.016666668F * f;
            ...
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            tessellator.func_78382_b();
            int j = fontrenderer.func_78256_a(p_77038_2_) / 2;
            tessellator.func_78369_a(0.0F, 0.0F, 0.0F, 0.25F);
            ...
            tessellator.func_78381_a();
            GL11.glEnable(GL11.GL_TEXTURE_2D);
            fontrenderer.func_78276_b(p_77038_2_, -fontrenderer.func_78256_a(p_77038_2_) / 2, b0, 553648127);
            GL11.glEnable(GL11.GL_DEPTH_TEST);
            GL11.glDepthMask(true);
            fontrenderer.func_78276_b(p_77038_2_, -fontrenderer.func_78256_a(p_77038_2_) / 2, b0, -1);
            GL11.glEnable(GL11.GL_LIGHTING);
            GL11.glDisable(GL11.GL_BLEND);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            GL11.glPopMatrix();
