...
public class RenderXPOrb extends Render
{
    ...
    public void func_77005_a(EntityXPOrb p_77005_1_, double p_77005_2_, double p_77005_4_, double p_77005_6_, float p_77005_8_, float p_77005_9_)
    {
        ...
        float f7 = 0.5F;
        float f8 = 0.25F;
        int j = p_77005_1_.func_70070_b(p_77005_9_);
        int k = j % 65536;
        int l = j / 65536;
        OpenGlHelper.func_77475_a(OpenGlHelper.field_77476_b, (float)k / 1.0F, (float)l / 1.0F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float f9 = 255.0F;
        float f10 = ((float)p_77005_1_.field_70533_a + p_77005_9_) / 2.0F;
        l = (int)((MathHelper.func_76126_a(f10 + 0.0F) + 1.0F) * 0.5F * f9);
        int i1 = (int)f9;
        int j1 = (int)((MathHelper.func_76126_a(f10 + 4.1887903F) + 1.0F) * 0.1F * f9);
        int k1 = l << 16 | i1 << 8 | j1;
