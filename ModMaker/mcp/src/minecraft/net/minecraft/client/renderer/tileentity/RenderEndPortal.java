...
public class RenderEndPortal extends TileEntitySpecialRenderer
{
    ...
    {
        float f1 = (float)this.field_76898_b.field_76967_j;
        float f2 = (float)this.field_76898_b.field_76968_k;
        float f3 = (float)this.field_76898_b.field_76965_l;
        ...
        for (int i = 0; i < 16; ++i)
        {
            ...
            tessellator.func_78377_a(p_76906_2_, p_76906_4_ + (double)f4, p_76906_6_);
            tessellator.func_78377_a(p_76906_2_, p_76906_4_ + (double)f4, p_76906_6_ + 1.0D);
            tessellator.func_78377_a(p_76906_2_ + 1.0D, p_76906_4_ + (double)f4, p_76906_6_ + 1.0D);
            tessellator.func_78377_a(p_76906_2_ + 1.0D, p_76906_4_ + (double)f4, p_76906_6_);
