        ...
        else
        {
            ...
            if (this.field_78406_i > 0)
            {
                ...
                if (this.field_78389_A)
                {
                    ...
                    ARBVertexBufferObject.glBindBufferARB(ARBVertexBufferObject.GL_ARRAY_BUFFER_ARB, this.field_78390_B.get(this.field_78391_C));
                    ARBVertexBufferObject.glBufferDataARB(ARBVertexBufferObject.GL_ARRAY_BUFFER_ARB, this.field_78394_d, ARBVertexBufferObject.GL_STREAM_DRAW_ARB);
                }
    ...
    public void func_78377_a(double p_78377_1_, double p_78377_3_, double p_78377_5_)
    {
        ...
        if (this.field_78409_u == 7 && field_78396_b && this.field_78411_s % 4 == 0)
        {
            for (int i = 0; i < 2; ++i)
            {
                ...
                if (this.field_78400_o)
                {
                    this.field_78405_h[this.field_78412_r + 3] = this.field_78405_h[this.field_78412_r - j + 3];
                    this.field_78405_h[this.field_78412_r + 4] = this.field_78405_h[this.field_78412_r - j + 4];
                }

                if (this.field_78414_p)
                {
                    this.field_78405_h[this.field_78412_r + 7] = this.field_78405_h[this.field_78412_r - j + 7];
                }

                if (this.field_78399_n)
                {
                    this.field_78405_h[this.field_78412_r + 5] = this.field_78405_h[this.field_78412_r - j + 5];
                }

                this.field_78405_h[this.field_78412_r + 0] = this.field_78405_h[this.field_78412_r - j + 0];
                this.field_78405_h[this.field_78412_r + 1] = this.field_78405_h[this.field_78412_r - j + 1];
                this.field_78405_h[this.field_78412_r + 2] = this.field_78405_h[this.field_78412_r - j + 2];
                ++this.field_78406_i;
