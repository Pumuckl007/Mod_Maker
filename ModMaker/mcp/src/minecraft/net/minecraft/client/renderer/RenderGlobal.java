...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void func_72712_a()
    {
        if (this.field_72769_h != null)
        {
            ...
            this.field_72766_m = i / 16 + 1;
            this.field_72763_n = 16;
            this.field_72764_o = i / 16 + 1;
            ...
            for (l = 0; l < this.field_72766_m; ++l)
            {
                for (int i1 = 0; i1 < this.field_72763_n; ++i1)
                {
                    ...
                    {
                        this.field_72765_l[(j1 * this.field_72763_n + i1) * this.field_72766_m + l] = new WorldRenderer(this.field_72769_h, this.field_72762_a, l * 16, i1 * 16, j1 * 16, this.field_72778_p + j);
    ...
    public void func_72713_a(Vec3 p_72713_1_, ICamera p_72713_2_, float p_72713_3_)
    {
        ...
        else
        {
            ...
            EntityLivingBase entitylivingbase = this.field_72777_q.field_71451_h;
            RenderManager.field_78725_b = entitylivingbase.field_70142_S + (entitylivingbase.field_70165_t - entitylivingbase.field_70142_S) * (double)p_72713_3_;
            RenderManager.field_78726_c = entitylivingbase.field_70137_T + (entitylivingbase.field_70163_u - entitylivingbase.field_70137_T) * (double)p_72713_3_;
            RenderManager.field_78723_d = entitylivingbase.field_70136_U + (entitylivingbase.field_70161_v - entitylivingbase.field_70136_U) * (double)p_72713_3_;
            TileEntityRenderer.field_76961_b = entitylivingbase.field_70142_S + (entitylivingbase.field_70165_t - entitylivingbase.field_70142_S) * (double)p_72713_3_;
            TileEntityRenderer.field_76962_c = entitylivingbase.field_70137_T + (entitylivingbase.field_70163_u - entitylivingbase.field_70137_T) * (double)p_72713_3_;
            TileEntityRenderer.field_76959_d = entitylivingbase.field_70136_U + (entitylivingbase.field_70161_v - entitylivingbase.field_70136_U) * (double)p_72713_3_;
            ...
            for (i = 0; i < list.size(); ++i)
            {
                ...
                boolean flag = entity.func_70102_a(p_72713_1_) && (entity.field_70158_ak || p_72713_2_.func_78546_a(entity.field_70121_D) || entity.field_70153_n == this.field_72777_q.field_71439_g);
                ...
                if (!flag && entity instanceof EntityLiving)
                {
                    ...
                    if (entityliving.func_110167_bD() && entityliving.func_110166_bE() != null)
                    {
                        ...
                        flag = p_72713_2_.func_78546_a(entity1.field_70121_D);
                    }
                }
            ...
            for (i = 0; i < this.field_72762_a.size(); ++i)
            {
                TileEntityRenderer.field_76963_a.func_76950_a((TileEntity)this.field_72762_a.get(i), p_72713_3_);
            }
    ...
    public int func_72719_a(EntityLivingBase p_72719_1_, int p_72719_2_, double p_72719_3_)
    {
        ...
        double d1 = p_72719_1_.field_70142_S + (p_72719_1_.field_70165_t - p_72719_1_.field_70142_S) * p_72719_3_;
        double d2 = p_72719_1_.field_70137_T + (p_72719_1_.field_70163_u - p_72719_1_.field_70137_T) * p_72719_3_;
        double d3 = p_72719_1_.field_70136_U + (p_72719_1_.field_70161_v - p_72719_1_.field_70136_U) * p_72719_3_;
        double d4 = p_72719_1_.field_70165_t - this.field_72758_d;
        double d5 = p_72719_1_.field_70163_u - this.field_72759_e;
        double d6 = p_72719_1_.field_70161_v - this.field_72756_f;
        ...
        if (this.field_72774_t && this.field_72777_q.field_71474_y.field_74349_h && !this.field_72777_q.field_71474_y.field_74337_g && p_72719_2_ == 0)
        {
            ...
            k = b0 + this.func_72724_a(b1, l, p_72719_2_, p_72719_3_);
            ...
            do
            {
                ...
                {
                    if (this.field_72768_k[k1].func_78906_e())
                    {
                        this.field_72768_k[k1].field_78927_l = false;
                    }
                    else
                    {
                        if (!this.field_72768_k[k1].field_78927_l)
                        {
                            this.field_72768_k[k1].field_78936_t = true;
                        }

                        if (this.field_72768_k[k1].field_78927_l && !this.field_72768_k[k1].field_78935_u)
                        {
                            float f3 = MathHelper.func_76129_c(this.field_72768_k[k1].func_78912_a(p_72719_1_));
                            int l1 = (int)(1.0F + f3 / 128.0F);

                            if (this.field_72773_u % l1 == k1 % l1)
                            {
                                WorldRenderer worldrenderer1 = this.field_72768_k[k1];
                                float f4 = (float)((double)worldrenderer1.field_78918_f - d1);
                                float f5 = (float)((double)worldrenderer1.field_78919_g - d2);
                                float f6 = (float)((double)worldrenderer1.field_78931_h - d3);
                                float f7 = f4 - f;
                                float f8 = f5 - f1;
                                float f9 = f6 - f2;
                                ...
                                ARBOcclusionQuery.glBeginQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB, this.field_72768_k[k1].field_78934_v);
                                this.field_72768_k[k1].func_78904_d();
                                ARBOcclusionQuery.glEndQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB);
                                this.field_72769_h.field_72984_F.func_76319_b();
                                this.field_72768_k[k1].field_78935_u = true;
                            }
                        }
                    }
                }
                ...
                this.field_72769_h.field_72984_F.func_76318_c("render");
                k += this.func_72724_a(j1, l, p_72719_2_, p_72719_3_);
            }
        ...
        {
            this.field_72769_h.field_72984_F.func_76318_c("render");
            k = b0 + this.func_72724_a(0, this.field_72768_k.length, p_72719_2_, p_72719_3_);
        }
    ...
    private int func_72724_a(int p_72724_1_, int p_72724_2_, int p_72724_3_, double p_72724_4_)
    {
        ...
        for (int i1 = p_72724_1_; i1 < p_72724_2_; ++i1)
        {
            if (p_72724_3_ == 0)
            {
                ++this.field_72751_K;

                if (this.field_72768_k[i1].field_78928_m[p_72724_3_])
                {
                    ++this.field_72747_O;
                }
                else if (!this.field_72768_k[i1].field_78927_l)
                {
                    ++this.field_72744_L;
                }
                else if (this.field_72774_t && !this.field_72768_k[i1].field_78936_t)
                {
                    ++this.field_72745_M;
                }
                else
            ...
            if (!this.field_72768_k[i1].field_78928_m[p_72724_3_] && this.field_72768_k[i1].field_78927_l && (!this.field_72774_t || this.field_72768_k[i1].field_78936_t))
            {
                int j1 = this.field_72768_k[i1].func_78909_a(p_72724_3_);

                if (j1 >= 0)
                {
                    this.field_72755_R.add(this.field_72768_k[i1]);
                    ++l;
                }
            }
        }
        ...
        EntityLivingBase entitylivingbase = this.field_72777_q.field_71451_h;
        double d1 = entitylivingbase.field_70142_S + (entitylivingbase.field_70165_t - entitylivingbase.field_70142_S) * p_72724_4_;
        double d2 = entitylivingbase.field_70137_T + (entitylivingbase.field_70163_u - entitylivingbase.field_70137_T) * p_72724_4_;
        double d3 = entitylivingbase.field_70136_U + (entitylivingbase.field_70161_v - entitylivingbase.field_70136_U) * p_72724_4_;
        int k1 = 0;
        int l1;

        for (l1 = 0; l1 < this.field_72754_S.length; ++l1)
        {
            this.field_72754_S[l1].func_78421_b();
        }

        for (l1 = 0; l1 < this.field_72755_R.size(); ++l1)
        {
            WorldRenderer worldrenderer = (WorldRenderer)this.field_72755_R.get(l1);
            int i2 = -1;

            for (int j2 = 0; j2 < k1; ++j2)
            {
                if (this.field_72754_S[j2].func_78418_a(worldrenderer.field_78918_f, worldrenderer.field_78919_g, worldrenderer.field_78931_h))
                {
                    i2 = j2;
                }
            }
            ...
            {
                i2 = k1++;
                this.field_72754_S[i2].func_78422_a(worldrenderer.field_78918_f, worldrenderer.field_78919_g, worldrenderer.field_78931_h, d1, d2, d3);
            }

            this.field_72754_S[i2].func_78420_a(worldrenderer.func_78909_a(p_72724_3_));
        }
    ...
    public void func_72714_a(float p_72714_1_)
    {
        ...
        else if (this.field_72777_q.field_71441_e.field_73011_w.func_76569_d())
        {
            ...
            if (afloat != null)
            {
                ...
                tessellator1.func_78369_a(f4, f7, f8, afloat[3]);
            ...
            GL11.glPushMatrix();
            f4 = 1.0F - this.field_72769_h.func_72867_j(p_72714_1_);
            f7 = 0.0F;
            f8 = 0.0F;
            f9 = 0.0F;
            ...
            tessellator1.func_78381_a();
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            float f18 = this.field_72769_h.func_72880_h(p_72714_1_) * f4;
    ...
    public void func_72718_b(float p_72718_1_)
    {
        if (this.field_72777_q.field_71441_e.field_73011_w.func_76569_d())
        {
            ...
            else
            {
                ...
                f5 = 4.8828125E-4F;
                double d0 = (double)((float)this.field_72773_u + p_72718_1_);
                double d1 = this.field_72777_q.field_71451_h.field_70169_q + (this.field_72777_q.field_71451_h.field_70165_t - this.field_72777_q.field_71451_h.field_70169_q) * (double)p_72718_1_ + d0 * 0.029999999329447746D;
                double d2 = this.field_72777_q.field_71451_h.field_70166_s + (this.field_72777_q.field_71451_h.field_70161_v - this.field_72777_q.field_71451_h.field_70166_s) * (double)p_72718_1_;
                int j = MathHelper.func_76128_c(d1 / 2048.0D);
                int k = MathHelper.func_76128_c(d2 / 2048.0D);
                d1 -= (double)(j * 2048);
                d2 -= (double)(k * 2048);
    ...
    public void func_72736_c(float p_72736_1_)
    {
        ...
        f10 = (float)(d2 * 0.0D);
        f9 = 0.00390625F;
        f8 = (float)MathHelper.func_76128_c(d1) * f9;
        f10 = (float)MathHelper.func_76128_c(d2) * f9;
            ...
            for (int l = -b1 + 1; l <= b1; ++l)
            {
                for (int i1 = -b1 + 1; i1 <= b1; ++i1)
                {
                    ...
                    if (f4 > -f3 - 1.0F)
                    {
                        ...
                        tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + 0.0F), (double)(f17 + (float)b0), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                        tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + 0.0F), (double)(f17 + (float)b0), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                        tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + 0.0F), (double)(f17 + 0.0F), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                        tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + 0.0F), (double)(f17 + 0.0F), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                    }
                    ...
                    if (f4 <= f3 + 1.0F)
                    {
                        ...
                        tessellator.func_78375_b(0.0F, 1.0F, 0.0F);
                        tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + f3 - f13), (double)(f17 + (float)b0), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                        tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + f3 - f13), (double)(f17 + (float)b0), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                        tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + f3 - f13), (double)(f17 + 0.0F), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                        tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + f3 - f13), (double)(f17 + 0.0F), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                    }
                    ...
                    if (l > -1)
                    {
                        ...
                        for (j1 = 0; j1 < b0; ++j1)
                        {
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 0.0F), (double)(f4 + 0.0F), (double)(f17 + (float)b0), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 0.0F), (double)(f4 + f3), (double)(f17 + (float)b0), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 0.0F), (double)(f4 + f3), (double)(f17 + 0.0F), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 0.0F), (double)(f4 + 0.0F), (double)(f17 + 0.0F), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                        }
                    }
                    ...
                    if (l <= 1)
                    {
                        ...
                        for (j1 = 0; j1 < b0; ++j1)
                        {
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 1.0F - f13), (double)(f4 + 0.0F), (double)(f17 + (float)b0), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 1.0F - f13), (double)(f4 + f3), (double)(f17 + (float)b0), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + (float)b0) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 1.0F - f13), (double)(f4 + f3), (double)(f17 + 0.0F), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)j1 + 1.0F - f13), (double)(f4 + 0.0F), (double)(f17 + 0.0F), (double)((f14 + (float)j1 + 0.5F) * f9 + f8), (double)((f15 + 0.0F) * f9 + f10));
                        }
                    }
                    ...
                    if (i1 > -1)
                    {
                        ...
                        for (j1 = 0; j1 < b0; ++j1)
                        {
                            tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + f3), (double)(f17 + (float)j1 + 0.0F), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + f3), (double)(f17 + (float)j1 + 0.0F), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + 0.0F), (double)(f17 + (float)j1 + 0.0F), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + 0.0F), (double)(f17 + (float)j1 + 0.0F), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                        }
                    }
                    ...
                    if (i1 <= 1)
                    {
                        ...
                        for (j1 = 0; j1 < b0; ++j1)
                        {
                            tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + f3), (double)(f17 + (float)j1 + 1.0F - f13), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + f3), (double)(f17 + (float)j1 + 1.0F - f13), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + (float)b0), (double)(f4 + 0.0F), (double)(f17 + (float)j1 + 1.0F - f13), (double)((f14 + (float)b0) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                            tessellator.func_78374_a((double)(f16 + 0.0F), (double)(f4 + 0.0F), (double)(f17 + (float)j1 + 1.0F - f13), (double)((f14 + 0.0F) * f9 + f8), (double)((f15 + (float)j1 + 0.5F) * f9 + f10));
                        }
                    }
    ...
    public boolean func_72716_a(EntityLivingBase p_72716_1_, boolean p_72716_2_)
    {
        ...
        for (k = 0; k < i; ++k)
        {
            ...
            if (worldrenderer != null)
            {
                if (!p_72716_2_)
                {
                    if (worldrenderer.func_78912_a(p_72716_1_) > 256.0F)
                    {
                        for (l = 0; l < b0 && (aworldrenderer[l] == null || rendersorter.func_78944_a(aworldrenderer[l], worldrenderer) <= 0); ++l)
                        {
                            ;
                        }
        ...
        for (j1 = b0 - 1; j1 >= 0; --j1)
        {
            ...
            {
                if (!worldrenderer1.field_78927_l && j1 != b0 - 1)
                {
        ...
        for (i1 = this.field_72767_j.size(); j1 != i1; ++j1)
        {
            WorldRenderer worldrenderer2 = (WorldRenderer)this.field_72767_j.get(j1);
            ...
            if (worldrenderer2 != null)
            {
                ...
                if (!flag1)
                {
                    if (l != j1)
                    {
                        this.field_72767_j.set(l, worldrenderer2);
                    }
    ...
    public void func_72717_a(Tessellator p_72717_1_, EntityPlayer p_72717_2_, float p_72717_3_)
    {
        ...
        if (!this.field_72738_E.isEmpty())
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    int i = this.field_72769_h.func_72798_a(destroyblockprogress.func_73110_b(), destroyblockprogress.func_73109_c(), destroyblockprogress.func_73108_d());
                    Block block = i > 0 ? Block.field_71973_m[i] : null;
                    ...
                    this.field_72776_r.func_78604_a(block, destroyblockprogress.func_73110_b(), destroyblockprogress.func_73109_c(), destroyblockprogress.func_73108_d(), this.field_94141_F[destroyblockprogress.func_73106_e()]);
                }
            }
    ...
    public void func_72731_b(EntityPlayer p_72731_1_, MovingObjectPosition p_72731_2_, int p_72731_3_, float p_72731_4_)
    {
        if (p_72731_3_ == 0 && p_72731_2_.field_72313_a == EnumMovingObjectType.TILE)
        {
            ...
            GL11.glDepthMask(false);
            float f1 = 0.002F;
            int j = this.field_72769_h.func_72798_a(p_72731_2_.field_72311_b, p_72731_2_.field_72312_c, p_72731_2_.field_72309_d);

            if (j > 0)
            {
                Block.field_71973_m[j].func_71902_a(this.field_72769_h, p_72731_2_.field_72311_b, p_72731_2_.field_72312_c, p_72731_2_.field_72309_d);
                ...
                this.func_72715_a(Block.field_71973_m[j].func_71911_a_(this.field_72769_h, p_72731_2_.field_72311_b, p_72731_2_.field_72312_c, p_72731_2_.field_72309_d).func_72314_b((double)f1, (double)f1, (double)f1).func_72325_c(-d0, -d1, -d2));
            }
    ...
    {
        ItemRecord itemrecord = ItemRecord.func_90042_d(p_72702_1_);

        if (p_72702_1_ != null && itemrecord != null)
        {
            this.field_72777_q.field_71456_v.func_73833_a(itemrecord.func_90043_g());
        }
    ...
    public void func_72708_a(String p_72708_1_, double p_72708_2_, double p_72708_4_, double p_72708_6_, double p_72708_8_, double p_72708_10_, double p_72708_12_)
    {
        ...
        catch (Throwable throwable)
        {
            ...
            crashreportcategory.func_71500_a("Position", new CallableParticlePositionInfo(this, p_72708_2_, p_72708_4_, p_72708_6_));
        ...
        if (this.field_72777_q != null && this.field_72777_q.field_71451_h != null && this.field_72777_q.field_71452_i != null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        entityfx = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, Item.field_77768_aD);
                    }
                    else if (p_72726_1_.equals("dripWater"))
                    {
                        entityfx = new EntityDropParticleFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, Material.field_76244_g);
                    }
                    else if (p_72726_1_.equals("dripLava"))
                    {
                        entityfx = new EntityDropParticleFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, Material.field_76256_h);
                    }
                    ...
                    {
                        entityfx = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, Item.field_77761_aM);
                    }
                    ...
                    else
                    {
                        ...
                        if (p_72726_1_.startsWith("iconcrack_"))
                        {
                            ...
                            if (astring.length > 2)
                            {
                                ...
                                entityfx = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Item.field_77698_e[j], k);
                            }
                            else
                            {
                                entityfx = new EntityBreakingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Item.field_77698_e[j], 0);
                            }
                        }
                        else if (p_72726_1_.startsWith("tilecrack_"))
                        {
                            ...
                            j = Integer.parseInt(astring[1]);
                            k = Integer.parseInt(astring[2]);
                            entityfx = (new EntityDiggingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, Block.field_71973_m[j], k)).func_90019_g(k);
                        }
                    }
    ...
    public void func_72706_a(EntityPlayer p_72706_1_, int p_72706_2_, int p_72706_3_, int p_72706_4_, int p_72706_5_, int p_72706_6_)
    {
        ...
        switch (p_72706_2_)
        {
            ...
            case 1022:
                ...
                break;
            case 2000:
                int l1 = p_72706_6_ % 3 - 1;
                int i2 = p_72706_6_ / 3 % 3 - 1;
                d1 = (double)p_72706_3_ + (double)l1 * 0.6D + 0.5D;
                d2 = (double)p_72706_4_ + 0.5D;
                double d8 = (double)p_72706_5_ + (double)i2 * 0.6D + 0.5D;
                ...
                for (int j2 = 0; j2 < 10; ++j2)
                {
                    ...
                    this.func_72708_a("smoke", d10, d7, d3, d4, d5, d6);
                }
            ...
            case 2001:
                ...
                if (k1 > 0)
                {
                    ...
                    this.field_72777_q.field_71416_A.func_77364_b(block.field_72020_cn.func_72676_a(), (float)p_72706_3_ + 0.5F, (float)p_72706_4_ + 0.5F, (float)p_72706_5_ + 0.5F, (block.field_72020_cn.func_72677_b() + 1.0F) / 2.0F, block.field_72020_cn.func_72678_c() * 0.8F);
                }
            ...
            case 2002:
                ...
                s = "iconcrack_" + Item.field_77726_bs.field_77779_bT + "_" + p_72706_6_;
                ...
                j1 = Item.field_77726_bs.func_77620_a(p_72706_6_);
                ...
                for (k1 = 0; k1 < 100; ++k1)
                {
                    ...
                    d6 = Math.sin(d3) * d7;
                    EntityFX entityfx = this.func_72726_b(s1, d0 + d4 * 0.1D, d1 + 0.3D, d2 + d6 * 0.1D, d4, d5, d6);
            ...
            case 2003:
                ...
                s = "iconcrack_" + Item.field_77748_bA.field_77779_bT;
                ...
                {
                    this.func_72708_a("portal", d0 + Math.cos(d11) * 5.0D, d1 - 0.4D, d2 + Math.sin(d11) * 5.0D, Math.cos(d11) * -5.0D, 0.0D, Math.sin(d11) * -5.0D);
                    this.func_72708_a("portal", d0 + Math.cos(d11) * 5.0D, d1 - 0.4D, d2 + Math.sin(d11) * 5.0D, Math.cos(d11) * -7.0D, 0.0D, Math.sin(d11) * -7.0D);
                }
            ...
            case 2004:
                ...
                {
                    double d12 = (double)p_72706_3_ + 0.5D + ((double)this.field_72769_h.field_73012_v.nextFloat() - 0.5D) * 2.0D;
                    double d13 = (double)p_72706_4_ + 0.5D + ((double)this.field_72769_h.field_73012_v.nextFloat() - 0.5D) * 2.0D;
                    double d14 = (double)p_72706_5_ + 0.5D + ((double)this.field_72769_h.field_73012_v.nextFloat() - 0.5D) * 2.0D;
                    this.field_72769_h.func_72869_a("smoke", d12, d13, d14, 0.0D, 0.0D, 0.0D);
                    this.field_72769_h.func_72869_a("flame", d12, d13, d14, 0.0D, 0.0D, 0.0D);
                }
    ...
    public void func_72705_a(int p_72705_1_, int p_72705_2_, int p_72705_3_, int p_72705_4_, int p_72705_5_)
    {
        ...
        {
            DestroyBlockProgress destroyblockprogress = (DestroyBlockProgress)this.field_72738_E.get(Integer.valueOf(p_72705_1_));
            ...
            if (destroyblockprogress == null || destroyblockprogress.func_73110_b() != p_72705_2_ || destroyblockprogress.func_73109_c() != p_72705_3_ || destroyblockprogress.func_73108_d() != p_72705_4_)
            {
                ...
                this.field_72738_E.put(Integer.valueOf(p_72705_1_), destroyblockprogress);
            }
