...
public class RenderWolf extends RenderLiving
{
    ...
    protected int func_82447_a(EntityWolf p_82447_1_, int p_82447_2_, float p_82447_3_)
    {
        ...
        {
            f1 = p_82447_1_.func_70013_c(p_82447_3_) * p_82447_1_.func_70915_j(p_82447_3_);
        ...
        else if (p_82447_2_ == 1 && p_82447_1_.func_70909_n())
        {
            ...
            f1 = 1.0F;
            int j = p_82447_1_.func_82186_bH();
            GL11.glColor3f(f1 * EntitySheep.field_70898_d[j][0], f1 * EntitySheep.field_70898_d[j][1], f1 * EntitySheep.field_70898_d[j][2]);
            return 1;
        }
        else
        {
