...
public class EntityRenderer
{
    ...
    public void func_78464_a()
    {
        ...
        f1 = (float)(3 - this.field_78531_r.field_71474_y.field_74339_e) / 3.0F;
    ...
    private float func_78481_a(float p_78481_1_, boolean p_78481_2_)
    {
        ...
        else
        {
            ...
            if (p_78481_2_)
            {
                f1 += this.field_78531_r.field_71474_y.field_74334_X * 40.0F;
            ...
            int i = ActiveRenderInfo.func_74584_a(this.field_78531_r.field_71441_e, entityplayer, p_78481_1_);
    ...
    private void func_78467_g(float p_78467_1_)
    {
        ...
        if (entitylivingbase.func_70608_bn())
        {
            ...
            {
                int i = this.field_78531_r.field_71441_e.func_72798_a(MathHelper.func_76128_c(entitylivingbase.field_70165_t), MathHelper.func_76128_c(entitylivingbase.field_70163_u), MathHelper.func_76128_c(entitylivingbase.field_70161_v));

                if (i == Block.field_71959_S.field_71990_ca)
                {
                    int j = this.field_78531_r.field_71441_e.func_72805_g(MathHelper.func_76128_c(entitylivingbase.field_70165_t), MathHelper.func_76128_c(entitylivingbase.field_70163_u), MathHelper.func_76128_c(entitylivingbase.field_70161_v));
                    int k = j & 3;
        ...
        else if (this.field_78531_r.field_71474_y.field_74320_O > 0)
        {
            ...
            if (this.field_78531_r.field_71474_y.field_74325_U)
            {
                f3 = this.field_78486_E + (this.field_78485_D - this.field_78486_E) * p_78467_1_;
            ...
            {
                f3 = entitylivingbase.field_70177_z;
                ...
                double d4 = (double)(-MathHelper.func_76126_a(f3 / 180.0F * (float)Math.PI) * MathHelper.func_76134_b(f2 / 180.0F * (float)Math.PI)) * d3;
                double d5 = (double)(MathHelper.func_76134_b(f3 / 180.0F * (float)Math.PI) * MathHelper.func_76134_b(f2 / 180.0F * (float)Math.PI)) * d3;
                ...
                for (int l = 0; l < 8; ++l)
                {
                    ...
                    f5 *= 0.1F;
                    f6 *= 0.1F;
                    MovingObjectPosition movingobjectposition = this.field_78531_r.field_71441_e.func_72933_a(this.field_78531_r.field_71441_e.func_82732_R().func_72345_a(d0 + (double)f4, d1 + (double)f5, d2 + (double)f6), this.field_78531_r.field_71441_e.func_82732_R().func_72345_a(d0 - d4 + (double)f4 + (double)f6, d1 - d6 + (double)f5, d2 - d5 + (double)f6));

                    if (movingobjectposition != null)
                    {
                        double d7 = movingobjectposition.field_72307_f.func_72438_d(this.field_78531_r.field_71441_e.func_82732_R().func_72345_a(d0, d1, d2));
    ...
    public void func_78480_b(float p_78480_1_)
    {
        ...
        if (!this.field_78531_r.field_71454_w)
        {
            ...
            ScaledResolution scaledresolution = new ScaledResolution(this.field_78531_r.field_71474_y, this.field_78531_r.field_71443_c, this.field_78531_r.field_71440_d);
            int i = scaledresolution.func_78326_a();
            int j = scaledresolution.func_78328_b();
            int k = Mouse.getX() * i / this.field_78531_r.field_71443_c;
            int l = j - Mouse.getY() * j / this.field_78531_r.field_71440_d - 1;
            int i1 = func_78465_a(this.field_78531_r.field_71474_y.field_74350_i);
            ...
            if (this.field_78531_r.field_71462_r != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.func_71500_a("Screen name", new CallableScreenName(this));
                    crashreportcategory.func_71500_a("Mouse location", new CallableMouseLocation(this, k, l));
                    crashreportcategory.func_71500_a("Screen size", new CallableScreenSize(this, scaledresolution));
    ...
    public void func_78471_a(float p_78471_1_, long p_78471_2_)
    {
        ...
        for (int j = 0; j < 2; ++j)
        {
            ...
            if (this.field_78532_q == 0)
            {
                ...
                renderglobal.func_72713_a(entitylivingbase.func_70666_h(p_78471_1_), frustrum, p_78471_1_);
                ...
                if (this.field_78531_r.field_71476_x != null && entitylivingbase.func_70055_a(Material.field_76244_g) && entitylivingbase instanceof EntityPlayer && !this.field_78531_r.field_71474_y.field_74319_N)
                {
            ...
            if (this.field_78531_r.field_71474_y.field_74347_j)
            {
                ...
                int l = renderglobal.func_72719_a(entitylivingbase, 1, (double)p_78471_1_);
                ...
                if (l > 0)
                {
                    renderglobal.func_72733_a(1, (double)p_78471_1_);
                }
            ...
            if (this.field_78503_V == 1.0D && entitylivingbase instanceof EntityPlayer && !this.field_78531_r.field_71474_y.field_74319_N && this.field_78531_r.field_71476_x != null && !entitylivingbase.func_70055_a(Material.field_76244_g))
            {
                entityplayer = (EntityPlayer)entitylivingbase;
                GL11.glDisable(GL11.GL_ALPHA_TEST);
                this.field_78531_r.field_71424_I.func_76318_c("outline");
    ...
    private void func_78484_h()
    {
        ...
        if (f != 0.0F)
        {
            ...
            for (int j1 = 0; j1 < i1; ++j1)
            {
                ...
                if (i2 <= j + b0 && i2 >= j - b0 && biomegenbase.func_76738_d() && biomegenbase.func_76743_j() >= 0.2F)
                {
                    ...
                    if (j2 > 0)
                    {
                        ...
                        {
                            this.field_78531_r.field_71452_i.func_78873_a(new EntitySmokeFX(worldclient, (double)((float)k1 + f1), (double)((float)i2 + 0.1F) - Block.field_71973_m[j2].func_83008_x(), (double)((float)l1 + f2), 0.0D, 0.0D, 0.0D));
                        }
                        else
                        {
                            ++l;
                            ...
                            if (this.field_78537_ab.nextInt(l) == 0)
                            {
                                ...
                                d1 = (double)((float)i2 + 0.1F) - Block.field_71973_m[j2].func_83008_x();
                                d2 = (double)((float)l1 + f2);
                            }

                            this.field_78531_r.field_71452_i.func_78873_a(new EntityRainFX(worldclient, (double)((float)k1 + f1), (double)((float)i2 + 0.1F) - Block.field_71973_m[j2].func_83008_x(), (double)((float)l1 + f2)));
                        }
                    }
                }
            }
    ...
    protected void func_78474_d(float p_78474_1_)
    {
        ...
        if (f1 > 0.0F)
        {
            ...
            EntityLivingBase entitylivingbase = this.field_78531_r.field_71451_h;
            WorldClient worldclient = this.field_78531_r.field_71441_e;
            int k = MathHelper.func_76128_c(entitylivingbase.field_70165_t);
            int l = MathHelper.func_76128_c(entitylivingbase.field_70163_u);
            int i1 = MathHelper.func_76128_c(entitylivingbase.field_70161_v);
            ...
            for (int k1 = i1 - b0; k1 <= i1 + b0; ++k1)
            {
                for (int l1 = k - b0; l1 <= k + b0; ++l1)
                {
                    ...
                    float f6 = this.field_78525_i[i2] * 0.5F;
                    float f7 = this.field_78522_j[i2] * 0.5F;
                    BiomeGenBase biomegenbase = worldclient.func_72807_a(l1, k1);

                    if (biomegenbase.func_76738_d() || biomegenbase.func_76746_c())
                    {
                        int j2 = worldclient.func_72874_g(l1, k1);
                        int k2 = l - b0;
                        int l2 = l + b0;
                        ...
                        if (k2 != l2)
                        {
                            ...
                            float f9 = biomegenbase.func_76743_j();
                            double d3;
                            float f10;

                            if (worldclient.func_72959_q().func_76939_a(f9, j2) >= 0.15F)
                            {
                                if (b1 != 0)
                                {
                                    if (b1 >= 0)
                                ...
                                f10 = ((float)(this.field_78529_t + l1 * l1 * 3121 + l1 * 45238971 + k1 * k1 * 418711 + k1 * 13761 & 31) + p_78474_1_) / 32.0F * (3.0F + this.field_78537_ab.nextFloat());
                                double d4 = (double)((float)l1 + 0.5F) - entitylivingbase.field_70165_t;
                                d3 = (double)((float)k1 + 0.5F) - entitylivingbase.field_70161_v;
                                float f11 = MathHelper.func_76133_a(d4 * d4 + d3 * d3) / (float)b0;
                                float f12 = 1.0F;
                                tessellator.func_78380_c(worldclient.func_72802_i(l1, i3, k1, 0));
                                tessellator.func_78369_a(f12, f12, f12, ((1.0F - f11 * f11) * 0.5F + 0.5F) * f1);
                                tessellator.func_78373_b(-d0 * 1.0D, -d1 * 1.0D, -d2 * 1.0D);
                                tessellator.func_78374_a((double)((float)l1 - f6) + 0.5D, (double)k2, (double)((float)k1 - f7) + 0.5D, (double)(0.0F * f8), (double)((float)k2 * f8 / 4.0F + f10 * f8));
                                tessellator.func_78374_a((double)((float)l1 + f6) + 0.5D, (double)k2, (double)((float)k1 + f7) + 0.5D, (double)(1.0F * f8), (double)((float)k2 * f8 / 4.0F + f10 * f8));
                                tessellator.func_78374_a((double)((float)l1 + f6) + 0.5D, (double)l2, (double)((float)k1 + f7) + 0.5D, (double)(1.0F * f8), (double)((float)l2 * f8 / 4.0F + f10 * f8));
                                tessellator.func_78374_a((double)((float)l1 - f6) + 0.5D, (double)l2, (double)((float)k1 - f7) + 0.5D, (double)(0.0F * f8), (double)((float)l2 * f8 / 4.0F + f10 * f8));
                            ...
                            else
                            {
                                ...
                                float f13 = this.field_78537_ab.nextFloat() + f5 * 0.01F * (float)this.field_78537_ab.nextGaussian();
                                float f14 = this.field_78537_ab.nextFloat() + f5 * (float)this.field_78537_ab.nextGaussian() * 0.001F;
                                d3 = (double)((float)l1 + 0.5F) - entitylivingbase.field_70165_t;
                                double d5 = (double)((float)k1 + 0.5F) - entitylivingbase.field_70161_v;
                                float f15 = MathHelper.func_76133_a(d3 * d3 + d5 * d5) / (float)b0;
                                float f16 = 1.0F;
                                tessellator.func_78380_c((worldclient.func_72802_i(l1, i3, k1, 0) * 3 + 15728880) / 4);
                                tessellator.func_78369_a(f16, f16, f16, ((1.0F - f15 * f15) * 0.3F + 0.5F) * f1);
                                tessellator.func_78373_b(-d0 * 1.0D, -d1 * 1.0D, -d2 * 1.0D);
                                tessellator.func_78374_a((double)((float)l1 - f6) + 0.5D, (double)k2, (double)((float)k1 - f7) + 0.5D, (double)(0.0F * f8 + f13), (double)((float)k2 * f8 / 4.0F + f10 * f8 + f14));
                                tessellator.func_78374_a((double)((float)l1 + f6) + 0.5D, (double)k2, (double)((float)k1 + f7) + 0.5D, (double)(1.0F * f8 + f13), (double)((float)k2 * f8 / 4.0F + f10 * f8 + f14));
                                tessellator.func_78374_a((double)((float)l1 + f6) + 0.5D, (double)l2, (double)((float)k1 + f7) + 0.5D, (double)(1.0F * f8 + f13), (double)((float)l2 * f8 / 4.0F + f10 * f8 + f14));
                                tessellator.func_78374_a((double)((float)l1 - f6) + 0.5D, (double)l2, (double)((float)k1 - f7) + 0.5D, (double)(0.0F * f8 + f13), (double)((float)l2 * f8 / 4.0F + f10 * f8 + f14));
                                tessellator.func_78373_b(0.0D, 0.0D, 0.0D);
                            }
                        }
                    }
    ...
    private void func_78466_h(float p_78466_1_)
    {
        WorldClient worldclient = this.field_78531_r.field_71441_e;
        EntityLivingBase entitylivingbase = this.field_78531_r.field_71451_h;
        float f1 = 1.0F / (float)(4 - this.field_78531_r.field_71474_y.field_74339_e);
        ...
        if (this.field_78531_r.field_71474_y.field_74339_e < 2)
        {
            Vec3 vec32 = MathHelper.func_76126_a(worldclient.func_72929_e(p_78466_1_)) > 0.0F ? worldclient.func_82732_R().func_72345_a(-1.0D, 0.0D, 0.0D) : worldclient.func_82732_R().func_72345_a(1.0D, 0.0D, 0.0D);
        ...
        float f6 = worldclient.func_72867_j(p_78466_1_);
        float f7;
        ...
        int i = ActiveRenderInfo.func_74584_a(this.field_78531_r.field_71441_e, entitylivingbase, p_78466_1_);
        float f8;
        ...
        else if (i != 0 && Block.field_71973_m[i].field_72018_cp == Material.field_76244_g)
        {
            ...
            this.field_78518_n = 0.02F + f8;
            this.field_78519_o = 0.02F + f8;
            this.field_78533_p = 0.2F + f8;
        }
        ...
        f8 = this.field_78535_ad + (this.field_78539_ae - this.field_78535_ad) * p_78466_1_;
        ...
        if (this.field_82831_U > 0.0F)
        {
            f9 = this.field_82832_V + (this.field_82831_U - this.field_82832_V) * p_78466_1_;
        ...
        {
            f9 = this.func_82830_a(this.field_78531_r.field_71439_g, p_78466_1_);
            f10 = 1.0F / this.field_78518_n;
            ...
            this.field_78518_n = this.field_78518_n * (1.0F - f9) + this.field_78518_n * f10 * f9;
            this.field_78519_o = this.field_78519_o * (1.0F - f9) + this.field_78519_o * f10 * f9;
            this.field_78533_p = this.field_78533_p * (1.0F - f9) + this.field_78533_p * f10 * f9;
        }

        if (this.field_78531_r.field_71474_y.field_74337_g)
        {
            f9 = (this.field_78518_n * 30.0F + this.field_78519_o * 59.0F + this.field_78533_p * 11.0F) / 100.0F;
            f10 = (this.field_78518_n * 30.0F + this.field_78519_o * 70.0F) / 100.0F;
            float f11 = (this.field_78518_n * 30.0F + this.field_78533_p * 70.0F) / 100.0F;
    ...
    private void func_78468_a(int p_78468_1_, float p_78468_2_)
    {
        ...
        else
        {
            ...
            GL11.glNormal3f(0.0F, -1.0F, 0.0F);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            int j = ActiveRenderInfo.func_74584_a(this.field_78531_r.field_71441_e, entitylivingbase, p_78468_2_);
            float f1;

            if (entitylivingbase.func_70644_a(Potion.field_76440_q))
            {
                f1 = 5.0F;
                int k = entitylivingbase.func_70660_b(Potion.field_76440_q).func_76459_b();

                if (k < 20)
                {
                    f1 = 5.0F + (this.field_78530_s - 5.0F) * (1.0F - (float)k / 20.0F);
                }
            ...
            else if (j > 0 && Block.field_71973_m[j].field_72018_cp == Material.field_76244_g)
            {
                GL11.glFogi(GL11.GL_FOG_MODE, GL11.GL_EXP);
            ...
            else if (j > 0 && Block.field_71973_m[j].field_72018_cp == Material.field_76256_h)
            {
                GL11.glFogi(GL11.GL_FOG_MODE, GL11.GL_EXP);
