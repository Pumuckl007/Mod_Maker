...
public class ModelDragon extends ModelBase
{
    ...
    public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        ...
        float f11 = this.func_78214_a(entitydragon.func_70974_a(5, this.field_78223_m)[0] - entitydragon.func_70974_a(10, this.field_78223_m)[0]);
        float f12 = this.func_78214_a(entitydragon.func_70974_a(5, this.field_78223_m)[0] + (double)(f11 / 2.0F));
        f8 += 2.0F;
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            this.field_78219_b.field_78796_g = this.func_78214_a(adouble1[0] - adouble[0]) * (float)Math.PI / 180.0F * f10;
            this.field_78219_b.field_78795_f = f15 + (float)(adouble1[1] - adouble[1]) * (float)Math.PI / 180.0F * f10 * 5.0F;
            this.field_78219_b.field_78808_h = -this.func_78214_a(adouble1[0] - (double)f12) * (float)Math.PI / 180.0F * f10;
            this.field_78219_b.field_78797_d = f8;
            this.field_78219_b.field_78798_e = f14;
            this.field_78219_b.field_78800_c = f9;
            f8 = (float)((double)f8 + Math.sin((double)this.field_78219_b.field_78795_f) * 10.0D);
            f14 = (float)((double)f14 - Math.cos((double)this.field_78219_b.field_78796_g) * Math.cos((double)this.field_78219_b.field_78795_f) * 10.0D);
            f9 = (float)((double)f9 - Math.sin((double)this.field_78219_b.field_78796_g) * Math.cos((double)this.field_78219_b.field_78795_f) * 10.0D);
            this.field_78219_b.func_78785_a(p_78088_7_);
        }

        this.field_78221_a.field_78797_d = f8;
        this.field_78221_a.field_78798_e = f14;
        this.field_78221_a.field_78800_c = f9;
        ...
        this.field_78221_a.field_78808_h = -this.func_78214_a(adouble2[0] - (double)f12) * (float)Math.PI / 180.0F * 1.0F;
        ...
        for (int k = 0; k < 12; ++k)
        {
            ...
            this.field_78219_b.field_78796_g = (this.func_78214_a(adouble2[0] - adouble[0]) * f10 + 180.0F) * (float)Math.PI / 180.0F;
            this.field_78219_b.field_78795_f = f16 + (float)(adouble2[1] - adouble[1]) * (float)Math.PI / 180.0F * f10 * 5.0F;
            this.field_78219_b.field_78808_h = this.func_78214_a(adouble2[0] - (double)f12) * (float)Math.PI / 180.0F * f10;
            this.field_78219_b.field_78797_d = f8;
            this.field_78219_b.field_78798_e = f14;
            this.field_78219_b.field_78800_c = f9;
            f8 = (float)((double)f8 + Math.sin((double)this.field_78219_b.field_78795_f) * 10.0D);
