...
public abstract class AbstractClientPlayer extends EntityPlayer
{
    ...
    private static ThreadDownloadImageData func_110301_a(ResourceLocation p_110301_0_, String p_110301_1_, ResourceLocation p_110301_2_, IImageBuffer p_110301_3_)
    {
        ...
        Object object = texturemanager.func_110581_b(p_110301_0_);

        if (object == null)
        {
            object = new ThreadDownloadImageData(p_110301_1_, p_110301_2_, p_110301_3_);
            texturemanager.func_110579_a(p_110301_0_, (TextureObject)object);
        }
