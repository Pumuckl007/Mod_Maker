...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public float func_71151_f()
    {
        ...
        f = (float)((double)f * ((attributeinstance.func_111126_e() / (double)this.field_71075_bZ.func_75094_b() + 1.0D) / 2.0D));
    ...
    public void func_71064_a(StatBase p_71064_1_, int p_71064_2_)
    {
        if (p_71064_1_ != null)
        {
            if (p_71064_1_.func_75967_d())
            {
                ...
                if (achievement.field_75992_c == null || this.field_71159_c.field_71413_E.func_77443_a(achievement.field_75992_c))
                {
                    if (!this.field_71159_c.field_71413_E.func_77443_a(achievement))
                    {
                        this.field_71159_c.field_71458_u.func_73846_a(achievement);
                    }
