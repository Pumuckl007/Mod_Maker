...
public class GuiScreenTemporaryResourcePackSelect extends GuiScreen
{
    ...
    protected void func_73875_a(GuiButton p_73875_1_)
    {
        if (p_73875_1_.field_73742_g)
        {
            ...
            {
                File file1 = GuiScreenTemporaryResourcePackSelectSelectionList.func_110510_a(this.field_110346_c).func_110612_e();
                ...
                if (Util.func_110647_a() == EnumOS.MACOS)
                {
                    try
                    {
                        this.field_73882_e.func_98033_al().func_98233_a(s);
