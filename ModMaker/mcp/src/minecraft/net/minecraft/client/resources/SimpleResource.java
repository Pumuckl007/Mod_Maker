...
public class SimpleResource implements Resource
{
    ...
    public MetadataSection func_110526_a(String p_110526_1_)
    {
        ...
        else
        {
            ...
            MetadataSection metadatasection = (MetadataSection)this.field_110535_a.get(p_110526_1_);

            if (metadatasection == null)
            {
                metadatasection = this.field_110532_e.func_110503_a(p_110526_1_, this.field_110530_g);
            }
