...
class GuiScreenTemporaryResourcePackSelectSelectionList extends GuiSlot
{
    ...
    {
        List list = this.field_110511_b.func_110609_b();
        ...
        try
        {
            ...
            this.field_110511_b.func_110615_a(new ResourcePackRepositoryEntry[] {(ResourcePackRepositoryEntry)list.get(p_77213_1_ - 1)});
    ...
    {
        List list = this.field_110511_b.func_110613_c();
        return p_77218_1_ == 0 ? list.isEmpty() : list.contains(this.field_110511_b.func_110609_b().get(p_77218_1_ - 1));
    }
    ...
    {
        TextureManager texturemanager = GuiScreenTemporaryResourcePackSelect.func_110340_f(this.field_110512_a).func_110434_K();
        ...
        if (p_77214_1_ == 0)
        {
            try
            {
                ...
                {
                    this.field_110513_h = texturemanager.func_110578_a("texturepackicon", new DynamicTexture(resourcepack.func_110586_a()));
                }

                texturemanager.func_110577_a(this.field_110513_h);
                ...
                this.field_110512_a.func_73731_b(GuiScreenTemporaryResourcePackSelect.func_130016_h(this.field_110512_a), packmetadatasection.func_110461_a(), p_77214_2_ + 32 + 2, p_77214_3_ + 12 + 10, 8421504);
            }
        ...
        {
            ResourcePackRepositoryEntry resourcepackrepositoryentry = (ResourcePackRepositoryEntry)this.field_110511_b.func_110609_b().get(p_77214_1_ - 1);
            ...
            this.field_110512_a.func_73731_b(GuiScreenTemporaryResourcePackSelect.func_110337_i(this.field_110512_a), s, p_77214_2_ + 32 + 2, p_77214_3_ + 1, 16777215);
            List list = GuiScreenTemporaryResourcePackSelect.func_110335_j(this.field_110512_a).func_78271_c(resourcepackrepositoryentry.func_110519_e(), 183);

            for (int i1 = 0; i1 < 2 && i1 < list.size(); ++i1)
            {
                this.field_110512_a.func_73731_b(GuiScreenTemporaryResourcePackSelect.func_110338_k(this.field_110512_a), (String)list.get(i1), p_77214_2_ + 32 + 2, p_77214_3_ + 12 + 10 * i1, 8421504);
            }
        }
    }
