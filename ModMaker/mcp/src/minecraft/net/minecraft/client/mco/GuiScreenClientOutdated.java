...
public class GuiScreenClientOutdated extends GuiScreen
{
    ...
    {
        this.func_73873_v_();
        String s = I18n.func_135053_a("mco.client.outdated.title");
        String s1 = I18n.func_135053_a("mco.client.outdated.msg");
        this.func_73732_a(this.field_73886_k, s, this.field_73880_f / 2, this.field_73881_g / 2 - 50, 16711680);
        this.func_73732_a(this.field_73886_k, s1, this.field_73880_f / 2, this.field_73881_g / 2 - 30, 16777215);
