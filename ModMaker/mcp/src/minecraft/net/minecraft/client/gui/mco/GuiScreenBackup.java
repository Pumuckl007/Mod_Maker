...
public class GuiScreenBackup extends GuiScreen
{
    ...
    protected void func_73875_a(GuiButton p_73875_1_)
    {
        if (p_73875_1_.field_73742_g)
        {
            ...
            {
                String s = I18n.func_135053_a("mco.configure.world.restore.question.line1");
                String s1 = I18n.func_135053_a("mco.configure.world.restore.question.line2");
    ...
    private void func_110374_h()
    {
        if (this.field_110376_e >= 0 && this.field_110376_e < this.field_110378_c.size())
        {
            ...
            GuiScreenLongRunningTask guiscreenlongrunningtask = new GuiScreenLongRunningTask(this.field_73882_e, this.field_110380_a, guiscreenbackuprestoretask);
