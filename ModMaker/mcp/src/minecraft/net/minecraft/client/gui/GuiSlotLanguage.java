...
class GuiSlotLanguage extends GuiSlot
{
    ...
    public GuiSlotLanguage(GuiLanguage p_i1042_1_)
    {
        ...
        Iterator iterator = GuiLanguage.func_135011_a(p_i1042_1_).func_135040_d().iterator();
    ...
    {
        Language language = (Language)this.field_77253_h.get(this.field_77251_g.get(p_77213_1_));
        GuiLanguage.func_135011_a(this.field_77252_a).func_135045_a(language);
        GuiLanguage.func_74043_a(this.field_77252_a).field_74363_ab = language.func_135034_a();
