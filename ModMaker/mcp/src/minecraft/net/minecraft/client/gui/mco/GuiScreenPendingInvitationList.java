...
class GuiScreenPendingInvitationList extends GuiScreenSelectLocation
{
    ...
    {
        PendingInvite pendinginvite = (PendingInvite)GuiScreenPendingInvitation.func_130042_e(this.field_130120_a).get(p_130119_1_);
        this.field_130120_a.func_73731_b(GuiScreenPendingInvitation.func_130045_k(this.field_130120_a), pendinginvite.field_130092_b, p_130119_2_ + 2, p_130119_3_ + 1, 16777215);
        this.field_130120_a.func_73731_b(GuiScreenPendingInvitation.func_130052_l(this.field_130120_a), pendinginvite.field_130093_c, p_130119_2_ + 2, p_130119_3_ + 12, 7105644);
    }
}
