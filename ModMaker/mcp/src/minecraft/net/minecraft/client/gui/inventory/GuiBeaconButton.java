...
class GuiBeaconButton extends GuiButton
{
    ...
    public void func_73737_a(Minecraft p_73737_1_, int p_73737_2_, int p_73737_3_)
    {
        if (this.field_73748_h)
        {
            ...
            {
                k += this.field_73747_a * 2;
            }
            else if (this.field_82256_n)
            {
                k += this.field_73747_a * 1;
            }
            else if (this.field_82253_i)
            {
                k += this.field_73747_a * 3;
            }

            this.func_73729_b(this.field_73746_c, this.field_73743_d, k, short1, this.field_73747_a, this.field_73745_b);
