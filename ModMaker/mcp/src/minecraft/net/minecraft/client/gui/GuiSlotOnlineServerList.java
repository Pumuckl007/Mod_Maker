...
class GuiSlotOnlineServerList extends GuiScreenSelectLocation
{
    ...
    protected void func_77213_a(int p_77213_1_, boolean p_77213_2_)
    {
        ...
        {
            McoServer mcoserver = (McoServer)GuiScreenOnlineServers.func_140013_c(this.field_96294_a).get(p_77213_1_);
            ...
            GuiScreenOnlineServers.func_140033_i(this.field_96294_a).field_73742_g = mcoserver.field_96404_d.equals("OPEN") && !mcoserver.field_98166_h;
    ...
    {
        McoServer mcoserver = (McoServer)GuiScreenOnlineServers.func_140013_c(this.field_96294_a).get(p_96292_1_);
        this.field_96294_a.func_73731_b(GuiScreenOnlineServers.func_140023_k(this.field_96294_a), mcoserver.func_96398_b(), p_96292_2_ + 2, p_96292_3_ + 1, 16777215);
        short short1 = 207;
        byte b0 = 1;

        if (mcoserver.field_98166_h)
        {
            GuiScreenOnlineServers.func_104031_c(this.field_96294_a, p_96292_2_ + short1, p_96292_3_ + b0, this.field_104094_d, this.field_104095_e);
        }
        else if (mcoserver.field_96404_d.equals("CLOSED"))
        {
            GuiScreenOnlineServers.func_140035_b(this.field_96294_a, p_96292_2_ + short1, p_96292_3_ + b0, this.field_104094_d, this.field_104095_e);
        }
        ...
        {
            this.func_96293_a(p_96292_1_, p_96292_2_ - 14, p_96292_3_, mcoserver);
            GuiScreenOnlineServers.func_140031_a(this.field_96294_a, p_96292_2_ + short1, p_96292_3_ + b0, this.field_104094_d, this.field_104095_e, mcoserver.field_104063_i);
        }
        else if (mcoserver.field_96404_d.equals("OPEN"))
        {
            GuiScreenOnlineServers.func_140020_c(this.field_96294_a, p_96292_2_ + short1, p_96292_3_ + b0, this.field_104094_d, this.field_104095_e);
            this.func_96293_a(p_96292_1_, p_96292_2_ - 14, p_96292_3_, mcoserver);
        }

        this.field_96294_a.func_73731_b(GuiScreenOnlineServers.func_140039_m(this.field_96294_a), mcoserver.func_96397_a(), p_96292_2_ + 2, p_96292_3_ + 12, 7105644);
        this.field_96294_a.func_73731_b(GuiScreenOnlineServers.func_98079_k(this.field_96294_a), mcoserver.field_96405_e, p_96292_2_ + 2, p_96292_3_ + 12 + 11, 5000268);
    }
