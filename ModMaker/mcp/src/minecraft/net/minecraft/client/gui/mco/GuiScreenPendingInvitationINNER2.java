...
class GuiScreenPendingInvitationINNER2 extends Thread
{
    ...
    public void run()
    {
        try
        {
            McoClient mcoclient = new McoClient(GuiScreenPendingInvitation.func_130041_c(this.field_130132_a).func_110432_I());
        ...
        {
            GuiScreenPendingInvitation.func_130056_g(this.field_130132_a).func_98033_al().func_98232_c(exceptionmcoservice.toString());
        }
    }
}
