...
public class GuiScreenEditOnlineWorld extends GuiScreen
{
    ...
    private void func_96200_g()
    {
        ...
        try
        {
            String s = this.field_96203_c.func_73781_b() != null && !this.field_96203_c.func_73781_b().trim().equals("") ? this.field_96203_c.func_73781_b() : null;
            mcoclient.func_96384_a(this.field_96205_n.field_96408_a, this.field_96201_d.func_73781_b(), s, this.field_104051_s.field_104076_e, this.field_104051_s.field_104073_f);
        ...
        {
            this.field_73882_e.func_98033_al().func_98236_b("Realms: " + unsupportedencodingexception.getLocalizedMessage());
        }
    }
