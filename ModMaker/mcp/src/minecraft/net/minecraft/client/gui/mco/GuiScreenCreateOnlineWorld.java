...
public class GuiScreenCreateOnlineWorld extends ScreenWithCallback
{
    ...
    private void func_96252_h()
    {
        ...
        {
            TaskWorldCreation taskworldcreation = new TaskWorldCreation(this, this.field_96257_c.func_73781_b(), "Minecraft Realms Server", this.field_98109_n, this.field_110356_u);
            GuiScreenLongRunningTask guiscreenlongrunningtask = new GuiScreenLongRunningTask(this.field_73882_e, this.field_96260_a, taskworldcreation);
