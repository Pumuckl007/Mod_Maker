...
public abstract class SelectionListBase
{
    ...
    public void func_96612_a(int p_96612_1_, int p_96612_2_, float p_96612_3_)
    {
        ...
        if (Mouse.isButtonDown(0))
        {
            if (this.field_96628_i == -1.0F)
            {
                ...
                if (p_96612_2_ >= this.field_96616_f && p_96612_2_ <= this.field_96627_h)
                {
                    ...
                    k1 = p_96612_2_ - this.field_96616_f + (int)this.field_96626_k - 4;
                    l1 = k1 / this.field_96620_b;

                    if (p_96612_1_ >= k2 && p_96612_1_ <= j1 && l1 >= 0 && k1 >= 0 && l1 < k)
                    {
                        boolean flag1 = l1 == this.field_96623_l && Minecraft.func_71386_F() - this.field_96624_m < 250L;
                        this.func_96615_a(l1, flag1);
                        this.field_96623_l = l1;
                        this.field_96624_m = Minecraft.func_71386_F();
                    }
                    else if (p_96612_1_ >= k2 && p_96612_1_ <= j1 && k1 < 0)
                    {
                        flag = false;
                    }

                    if (p_96612_1_ >= l && p_96612_1_ <= i1)
                    {
        ...
        tessellator.func_78374_a((double)this.field_96619_e, (double)this.field_96627_h, 0.0D, (double)((float)this.field_96619_e / f1), (double)((float)(this.field_96627_h + (int)this.field_96626_k) / f1));
        tessellator.func_78374_a((double)this.field_96617_g, (double)this.field_96627_h, 0.0D, (double)((float)this.field_96617_g / f1), (double)((float)(this.field_96627_h + (int)this.field_96626_k) / f1));
        tessellator.func_78374_a((double)this.field_96617_g, (double)this.field_96616_f, 0.0D, (double)((float)this.field_96617_g / f1), (double)((float)(this.field_96616_f + (int)this.field_96626_k) / f1));
        tessellator.func_78374_a((double)this.field_96619_e, (double)this.field_96616_f, 0.0D, (double)((float)this.field_96619_e / f1), (double)((float)(this.field_96616_f + (int)this.field_96626_k) / f1));
        ...
        tessellator.func_78374_a((double)this.field_96619_e, (double)(this.field_96616_f + b0), 0.0D, 0.0D, 1.0D);
        tessellator.func_78374_a((double)this.field_96617_g, (double)(this.field_96616_f + b0), 0.0D, 1.0D, 1.0D);
        tessellator.func_78384_a(0, 255);
        tessellator.func_78374_a((double)this.field_96617_g, (double)this.field_96616_f, 0.0D, 1.0D, 0.0D);
        tessellator.func_78374_a((double)this.field_96619_e, (double)this.field_96616_f, 0.0D, 0.0D, 0.0D);
        tessellator.func_78381_a();
        tessellator.func_78382_b();
        tessellator.func_78384_a(0, 255);
        tessellator.func_78374_a((double)this.field_96619_e, (double)this.field_96627_h, 0.0D, 0.0D, 1.0D);
        tessellator.func_78374_a((double)this.field_96617_g, (double)this.field_96627_h, 0.0D, 1.0D, 1.0D);
        tessellator.func_78384_a(0, 0);
        tessellator.func_78374_a((double)this.field_96617_g, (double)(this.field_96627_h - b0), 0.0D, 1.0D, 0.0D);
        tessellator.func_78374_a((double)this.field_96619_e, (double)(this.field_96627_h - b0), 0.0D, 0.0D, 0.0D);
        tessellator.func_78381_a();
        j2 = this.func_96607_d();
        ...
        if (j2 > 0)
        {
            ...
            tessellator.func_78382_b();
            tessellator.func_78384_a(0, 255);
            tessellator.func_78374_a((double)l, (double)this.field_96627_h, 0.0D, 0.0D, 1.0D);
            tessellator.func_78374_a((double)i1, (double)this.field_96627_h, 0.0D, 1.0D, 1.0D);
            tessellator.func_78374_a((double)i1, (double)this.field_96616_f, 0.0D, 1.0D, 0.0D);
            tessellator.func_78374_a((double)l, (double)this.field_96616_f, 0.0D, 0.0D, 0.0D);
            tessellator.func_78381_a();
            tessellator.func_78382_b();
