...
public class GuiScreenResetWorld extends ScreenWithCallback
{
    ...
    protected void func_73875_a(GuiButton p_73875_1_)
    {
        if (p_73875_1_.field_73742_g)
        {
            ...
            {
                String s = I18n.func_135053_a("mco.configure.world.reset.question.line1");
                String s1 = I18n.func_135053_a("mco.configure.world.reset.question.line2");
                this.field_73882_e.func_71373_a(new GuiScreenConfirmation(this, GuiScreenConfirmationType.Warning, s, s1, 1));
            }
    ...
    {
        TaskResetWorld taskresetworld = new TaskResetWorld(this, this.field_96150_b.field_96408_a, this.field_96151_c.func_73781_b(), this.field_110359_q);
        GuiScreenLongRunningTask guiscreenlongrunningtask = new GuiScreenLongRunningTask(this.field_73882_e, this.field_96152_a, taskresetworld);
