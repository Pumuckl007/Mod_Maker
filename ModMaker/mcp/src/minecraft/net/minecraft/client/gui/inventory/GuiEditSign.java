...
public class GuiEditSign extends GuiScreen
{
    ...
    public void func_73874_b()
    {
        ...
        NetClientHandler netclienthandler = this.field_73882_e.func_71391_r();

        if (netclienthandler != null)
        {
            netclienthandler.func_72552_c(new Packet130UpdateSign(this.field_73982_c.field_70329_l, this.field_73982_c.field_70330_m, this.field_73982_c.field_70327_n, this.field_73982_c.field_70412_a));
        }
    ...
    public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        Block block = this.field_73982_c.func_70311_o();

        if (block == Block.field_72053_aD)
        {
            float f2 = (float)(this.field_73982_c.func_70322_n() * 360) / 16.0F;
            GL11.glRotatef(f2, 0.0F, 1.0F, 0.0F);
            GL11.glTranslatef(0.0F, -1.0625F, 0.0F);
        }
        else
        {
            int k = this.field_73982_c.func_70322_n();
            float f3 = 0.0F;
