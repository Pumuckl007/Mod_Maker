...
public class GuiFlatPresets extends GuiScreen
{
    ...
    public void func_82296_g()
    {
        ...
        this.field_82304_p.field_73742_g = flag;
    }
    ...
    public static void func_82294_a(String p_82294_0_, int p_82294_1_, BiomeGenBase p_82294_2_, List p_82294_3_, FlatLayerInfo ... p_82294_4_)
    {
        ...
        for (int j = p_82294_4_.length - 1; j >= 0; --j)
        {
            flatgeneratorinfo.func_82650_c().add(p_82294_4_[j]);
        }

        flatgeneratorinfo.func_82647_a(p_82294_2_.field_76756_M);
        flatgeneratorinfo.func_82645_d();

        if (p_82294_3_ != null)
        {
            Iterator iterator = p_82294_3_.iterator();
        ...
        field_82301_b.add(new GuiFlatPresetsItem(p_82294_1_, p_82294_0_, flatgeneratorinfo.toString()));
    }
