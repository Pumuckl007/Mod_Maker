...
class ThreadOnlineScreen extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            if (mcoserver != null)
            {
                McoClient mcoclient = new McoClient(GuiScreenOnlineServers.func_98075_b(this.field_98173_a).func_110432_I());
        ...
        {
            GuiScreenOnlineServers.func_98076_f(this.field_98173_a).func_98033_al().func_98232_c(exceptionmcoservice.toString());
        }
    }
}
