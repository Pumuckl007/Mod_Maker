...
class SelectionListInvited extends SelectionListBase
{
    ...
    {
        String s = (String)GuiScreenConfigureWorld.func_96266_d(this.field_98264_a).field_96402_f.get(p_98263_1_);
        this.field_98264_a.func_73731_b(GuiScreenConfigureWorld.func_96273_f(this.field_98264_a), s, p_98263_2_ + 2, p_98263_3_ + 1, 16777215);
    }
}
