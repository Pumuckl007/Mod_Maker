...
public class GuiChest extends GuiContainer
{
    ...
    public GuiChest(IInventory p_i1083_1_, IInventory p_i1083_2_)
    {
        ...
        this.field_74195_c = i + this.field_74218_q * 18;
    }
    ...
    protected void func_74185_a(float p_74185_1_, int p_74185_2_, int p_74185_3_)
    {
        ...
        this.func_73729_b(k, l, 0, 0, this.field_74194_b, this.field_74218_q * 18 + 17);
        this.func_73729_b(k, l + this.field_74218_q * 18 + 17, 0, 126, this.field_74194_b, 96);
    }
}
