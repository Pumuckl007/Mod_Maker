...
public class ScreenChatOptions extends GuiScreen
{
    ...
    public void func_73866_w_()
    {
        ...
        for (k = 0; k < j; ++k)
        {
            ...
            {
                this.field_73887_h.add(new GuiSlider(enumoptions.func_74381_c(), this.field_73880_f / 2 - 155 + i % 2 * 160, this.field_73881_g / 6 + 24 * (i >> 1), enumoptions, this.field_73890_c.func_74297_c(enumoptions), this.field_73890_c.func_74296_a(enumoptions)));
            }
            else
            {
                this.field_73887_h.add(new GuiSmallButton(enumoptions.func_74381_c(), this.field_73880_f / 2 - 155 + i % 2 * 160, this.field_73881_g / 6 + 24 * (i >> 1), enumoptions, this.field_73890_c.func_74297_c(enumoptions)));
            }
        ...
        this.field_82269_o = this.field_73881_g / 6 + 24 * (i >> 1);
        i += 2;
        aenumoptions = field_82267_b;
