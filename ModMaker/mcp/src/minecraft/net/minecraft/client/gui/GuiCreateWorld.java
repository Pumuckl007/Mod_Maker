...
public class GuiCreateWorld extends GuiScreen
{
    ...
    private void func_73912_g()
    {
        ...
        {
            char c0 = achar[j];
            this.field_73918_d = this.field_73918_d.replace(c0, '_');
        }
    ...
    public static String func_73913_a(ISaveFormat p_73913_0_, String p_73913_1_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            if (p_73913_1_.equalsIgnoreCase(s1))
            {
    ...
    protected void func_73875_a(GuiButton p_73875_1_)
    {
        if (p_73875_1_.field_73742_g)
        {
            ...
            else if (p_73875_1_.field_73741_f == 0)
            {
                ...
                String s = this.field_73921_c.func_73781_b();
