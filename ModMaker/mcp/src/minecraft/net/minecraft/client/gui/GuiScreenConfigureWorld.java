...
public class GuiScreenConfigureWorld extends GuiScreen
{
    ...
    protected void func_73875_a(GuiButton p_73875_1_)
    {
        if (p_73875_1_.field_73742_g)
        {
            ...
            {
                String s = I18n.func_135053_a("mco.configure.world.close.question.line1");
                String s1 = I18n.func_135053_a("mco.configure.world.close.question.line2");
                this.field_73882_e.func_71373_a(new GuiScreenConfirmation(this, GuiScreenConfirmationType.Info, s, s1, 1));
            }
    ...
    private void func_96272_i()
    {
        if (this.field_96284_p >= 0 && this.field_96284_p < this.field_96280_b.field_96402_f.size())
        {
            ...
            GuiYesNo guiyesno = new GuiYesNo(this, "Warning!", I18n.func_135053_a("mco.configure.world.uninvite.question") + " \'" + this.field_96283_q + "\'", 3);
