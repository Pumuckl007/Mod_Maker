...
class GuiScreenMcoWorldTemplateSelectionList extends GuiScreenSelectLocation
{
    ...
    {
        WorldTemplate worldtemplate = (WorldTemplate)GuiScreenMcoWorldTemplate.func_110395_c(this.field_111245_a).get(p_111244_1_);
        this.field_111245_a.func_73731_b(GuiScreenMcoWorldTemplate.func_110389_g(this.field_111245_a), worldtemplate.field_110732_b, p_111244_2_ + 2, p_111244_3_ + 1, 16777215);
        this.field_111245_a.func_73731_b(GuiScreenMcoWorldTemplate.func_110387_h(this.field_111245_a), worldtemplate.field_110731_d, p_111244_2_ + 2, p_111244_3_ + 12, 7105644);
        this.field_111245_a.func_73731_b(GuiScreenMcoWorldTemplate.func_110384_i(this.field_111245_a), worldtemplate.field_110733_c, p_111244_2_ + 2 + 207 - GuiScreenMcoWorldTemplate.func_130063_j(this.field_111245_a).func_78256_a(worldtemplate.field_110733_c), p_111244_3_ + 1, 5000268);
    }
}
