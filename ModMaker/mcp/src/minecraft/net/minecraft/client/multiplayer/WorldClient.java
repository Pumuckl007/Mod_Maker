...
public class WorldClient extends World
{
    ...
    public void func_73029_E(int p_73029_1_, int p_73029_2_, int p_73029_3_)
    {
        ...
        for (int l = 0; l < 1000; ++l)
        {
            ...
            int l1 = this.func_72798_a(i1, j1, k1);
            ...
            {
                Block.field_71973_m[l1].func_71862_a(this, i1, j1, k1, random);
            }
        }
    }
    ...
    public CrashReportCategory func_72914_a(CrashReport p_72914_1_)
    {
        ...
        crashreportcategory.func_71500_a("Forced entities", new CallableMPL1(this));
        crashreportcategory.func_71500_a("Retry entities", new CallableMPL2(this));
    ...
    public void func_72980_b(double p_72980_1_, double p_72980_3_, double p_72980_5_, String p_72980_7_, float p_72980_8_, float p_72980_9_, boolean p_72980_10_)
    {
        ...
        if (d3 < (double)(f2 * f2))
        {
            if (p_72980_10_ && d3 > 100.0D)
            {
                ...
                this.field_73037_M.field_71416_A.func_92070_a(p_72980_7_, (float)p_72980_1_, (float)p_72980_3_, (float)p_72980_5_, p_72980_8_, p_72980_9_, (int)Math.round(d4 * 20.0D));
            }
            else
            {
