...
public class ItemEditableBook extends Item
{
    ...
    public static boolean func_77828_a(NBTTagCompound p_77828_0_)
    {
        ...
        else
        {
            ...
            return s != null && s.length() <= 16 ? p_77828_0_.func_74764_b("author") : false;
        }
    }
    ...
    public void func_77624_a(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_)
    {
        if (p_77624_1_.func_77942_o())
        {
            ...
            if (nbttagstring != null)
            {
                p_77624_3_.add(EnumChatFormatting.GRAY + String.format(StatCollector.func_74837_a("book.byAuthor", new Object[] {nbttagstring.field_74751_a}), new Object[0]));
            }
        }
    }
