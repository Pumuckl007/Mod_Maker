    ...
    public void func_77586_a(CraftingManager p_77586_1_)
    {
        for (int i = 0; i < this.field_77587_b[0].length; ++i)
        {
            ...
            for (int j = 0; j < this.field_77587_b.length - 1; ++j)
            {
                ...
                p_77586_1_.func_92103_a(new ItemStack(item), new Object[] {this.field_77588_a[j], '#', Item.field_77669_D, 'X', object});
            }
        }

        p_77586_1_.func_92103_a(new ItemStack(Item.field_77745_be), new Object[] {" #", "# ", '#', Item.field_77703_o});
    }
}
