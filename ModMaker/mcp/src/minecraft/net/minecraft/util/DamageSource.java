...
public class DamageSource
{
    ...
    {
        EntityLivingBase entitylivingbase1 = p_76360_1_.func_94060_bK();
        String s = "death.attack." + this.field_76373_n;
        String s1 = s + ".player";
        return entitylivingbase1 != null && StatCollector.func_94522_b(s1) ? ChatMessageComponent.func_111082_b(s1, new Object[] {p_76360_1_.func_96090_ax(), entitylivingbase1.func_96090_ax()}): ChatMessageComponent.func_111082_b(s, new Object[] {p_76360_1_.func_96090_ax()});
    }
