...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void func_70037_a(NBTTagCompound p_70037_1_)
    {
        ...
        else
        {
            ...
            {
                this.func_70606_j(((NBTTagFloat)nbtbase).field_74750_a);
            }
            else if (nbtbase.func_74732_a() == 2)
            {
                this.func_70606_j((float)((NBTTagShort)nbtbase).field_74752_a);
            }
        }
    ...
    protected void func_70679_bo()
    {
        ...
        boolean flag = this.field_70180_af.func_75683_a(8) > 0;
            ...
            for (double d4 = -1.5D; d4 < 2.0D; ++d4)
            {
                if (d3 != 0.0D || d4 != 0.0D)
                {
                    ...
                    if (this.field_70170_p.func_72840_a(axisalignedbb).isEmpty())
                    {
                        ...
                        {
                            this.func_70634_a(this.field_70165_t + d3, this.field_70163_u + 1.0D, this.field_70161_v + d4);
                            return;
                        }
    ...
    public MovingObjectPosition func_70614_a(double p_70614_1_, float p_70614_3_)
    {
        ...
        return this.field_70170_p.func_72933_a(vec3, vec32);
    }
