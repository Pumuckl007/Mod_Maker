...
public class EntityWolf extends EntityTameable
{
    ...
    public boolean func_70085_c(EntityPlayer p_70085_1_)
    {
        ...
        if (this.func_70909_n())
        {
            if (itemstack != null)
            {
                if (Item.field_77698_e[itemstack.field_77993_c] instanceof ItemFood)
                {
                    ...
                    if (itemfood.func_77845_h() && this.field_70180_af.func_111145_d(18) < 20.0F)
                    {
                        ...
                        this.func_70691_i((float)itemfood.func_77847_f());
                ...
                {
                    int i = BlockColored.func_72238_e_(itemstack.func_77960_j());
            ...
            if (p_70085_1_.func_70005_c_().equalsIgnoreCase(this.func_70905_p()) && !this.field_70170_p.field_72995_K && !this.func_70877_b(itemstack))
            {
