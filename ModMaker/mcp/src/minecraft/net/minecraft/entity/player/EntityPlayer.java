...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    public EntityPlayer(World p_i1752_1_, String p_i1752_2_)
    {
        ...
        ChunkCoordinates chunkcoordinates = p_i1752_1_.func_72861_E();
    ...
    public void func_70636_d()
    {
        ...
        if (!this.field_70170_p.field_72995_K)
        {
            attributeinstance.func_111128_a((double)this.field_71075_bZ.func_75094_b());
        }
    ...
    {
        Icon icon = super.func_70620_b(p_70620_1_, p_70620_2_);
