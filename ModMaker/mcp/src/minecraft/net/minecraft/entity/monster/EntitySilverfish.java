    ...
    protected void func_70626_be()
    {
        ...
        if (!this.field_70170_p.field_72995_K)
        {
                            ...
                            for (int j1 = 0; !flag && j1 <= 10 && j1 >= -10; j1 = j1 <= 0 ? 1 - j1 : 0 - j1)
                            {
                                ...
                                if (k1 == Block.field_72006_bl.field_71990_ca)
                                {
                                    if (!this.field_70170_p.func_82736_K().func_82766_b("mobGriefing"))
                                    {
                                        ...
                                        this.field_70170_p.func_72832_d(i + i1, j + l, k + j1, block.field_71990_ca, 0, 3);
                                    }
                                    else
                                    {
            ...
            if (this.field_70789_a == null && !this.func_70781_l())
            {
                ...
                k = MathHelper.func_76128_c(this.field_70161_v);
                int i2 = this.field_70146_Z.nextInt(6);
                l = this.field_70170_p.func_72798_a(i + Facing.field_71586_b[i2], j + Facing.field_71587_c[i2], k + Facing.field_71585_d[i2]);
