...
public class EntityEnderman extends EntityMob
{
    ...
    private boolean func_70821_d(EntityPlayer p_70821_1_)
    {
        ...
        else
        {
            ...
            Vec3 vec31 = this.field_70170_p.func_82732_R().func_72345_a(this.field_70165_t - p_70821_1_.field_70165_t, this.field_70121_D.field_72338_b + (double)(this.field_70131_O / 2.0F) - (p_70821_1_.field_70163_u + (double)p_70821_1_.func_70047_e()), this.field_70161_v - p_70821_1_.field_70161_v);
    ...
    public void func_70636_d()
    {
        ...
        if (!this.field_70170_p.field_72995_K && this.field_70170_p.func_82736_K().func_82766_b("mobGriefing"))
        {
            ...
            if (this.func_70822_p() == 0)
            {
                ...
                {
                    i = MathHelper.func_76128_c(this.field_70165_t - 2.0D + this.field_70146_Z.nextDouble() * 4.0D);
                    j = MathHelper.func_76128_c(this.field_70163_u + this.field_70146_Z.nextDouble() * 3.0D);
                    k = MathHelper.func_76128_c(this.field_70161_v - 2.0D + this.field_70146_Z.nextDouble() * 4.0D);
                    l = this.field_70170_p.func_72798_a(i, j, k);
            ...
            {
                i = MathHelper.func_76128_c(this.field_70165_t - 1.0D + this.field_70146_Z.nextDouble() * 2.0D);
                j = MathHelper.func_76128_c(this.field_70163_u + this.field_70146_Z.nextDouble() * 2.0D);
                k = MathHelper.func_76128_c(this.field_70161_v - 1.0D + this.field_70146_Z.nextDouble() * 2.0D);
                l = this.field_70170_p.func_72798_a(i, j, k);
                int i1 = this.field_70170_p.func_72798_a(i, j - 1, k);
    ...
    {
        Vec3 vec3 = this.field_70170_p.func_82732_R().func_72345_a(this.field_70165_t - p_70816_1_.field_70165_t, this.field_70121_D.field_72338_b + (double)(this.field_70131_O / 2.0F) - p_70816_1_.field_70163_u + (double)p_70816_1_.func_70047_e(), this.field_70161_v - p_70816_1_.field_70161_v);
    ...
    protected boolean func_70825_j(double p_70825_1_, double p_70825_3_, double p_70825_5_)
    {
        ...
        if (this.field_70170_p.func_72899_e(i, j, k))
        {
            ...
            while (!flag1 && j > 0)
            {
                ...
                if (l != 0 && Block.field_71973_m[l].field_72018_cp.func_76230_c())
                {
                    flag1 = true;
                }
                else
