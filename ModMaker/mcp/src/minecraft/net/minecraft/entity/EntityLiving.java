...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        if (this.field_110168_bw != null)
        {
            ...
            else if (this.field_110168_bw instanceof EntityHanging)
            {
                ...
                nbttagcompound1.func_74768_a("X", entityhanging.field_70523_b);
                nbttagcompound1.func_74768_a("Y", entityhanging.field_70524_c);
                nbttagcompound1.func_74768_a("Z", entityhanging.field_70521_d);
            }
    ...
    public void func_70625_a(Entity p_70625_1_, float p_70625_2_, float p_70625_3_)
    {
        ...
        if (p_70625_1_ instanceof EntityLivingBase)
        {
            ...
            d2 = entitylivingbase.field_70163_u + (double)entitylivingbase.func_70047_e() - (this.field_70163_u + (double)this.func_70047_e());
        }
        else
        {
    ...
    public final boolean func_130002_c(EntityPlayer p_130002_1_)
    {
        ...
        else
        {
            ...
            if (itemstack != null && itemstack.field_77993_c == Item.field_111214_ch.field_77779_bT && this.func_110164_bC())
            {
