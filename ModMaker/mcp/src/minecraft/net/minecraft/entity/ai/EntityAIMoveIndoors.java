...
public class EntityAIMoveIndoors extends EntityAIBase
{
    ...
    public boolean func_75250_a()
    {
        if ((!this.field_75424_a.field_70170_p.func_72935_r() || this.field_75424_a.field_70170_p.func_72896_J()) && !this.field_75424_a.field_70170_p.field_73011_w.field_76576_e)
        {
            ...
            {
                Village village = this.field_75424_a.field_70170_p.field_72982_D.func_75550_a(MathHelper.func_76128_c(this.field_75424_a.field_70165_t), MathHelper.func_76128_c(this.field_75424_a.field_70163_u), MathHelper.func_76128_c(this.field_75424_a.field_70161_v), 14);
                ...
                {
                    this.field_75422_b = village.func_75569_c(MathHelper.func_76128_c(this.field_75424_a.field_70165_t), MathHelper.func_76128_c(this.field_75424_a.field_70163_u), MathHelper.func_76128_c(this.field_75424_a.field_70161_v));
    ...
    public void func_75249_e()
    {
        ...
        {
            Vec3 vec3 = RandomPositionGenerator.func_75464_a(this.field_75424_a, 14, 3, this.field_75424_a.field_70170_p.func_82732_R().func_72345_a((double)this.field_75422_b.func_75471_a() + 0.5D, (double)this.field_75422_b.func_75473_b(), (double)this.field_75422_b.func_75472_c() + 0.5D));
