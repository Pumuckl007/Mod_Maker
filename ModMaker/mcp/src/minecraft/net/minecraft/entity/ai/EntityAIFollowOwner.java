...
public class EntityAIFollowOwner extends EntityAIBase
{
    ...
    {
        EntityLivingBase entitylivingbase = this.field_75338_d.func_130012_q();
                    ...
                    if (!this.field_75338_d.func_110167_bD())
                    {
                        if (this.field_75338_d.func_70068_e(this.field_75339_e) >= 144.0D)
                        {
                            ...
                            for (int l = 0; l <= 4; ++l)
                            {
                                ...
                                {
                                    if ((l < 1 || i1 < 1 || l > 3 || i1 > 3) && this.field_75342_a.func_72797_t(i + l, k - 1, j + i1) && !this.field_75342_a.func_72809_s(i + l, k, j + i1) && !this.field_75342_a.func_72809_s(i + l, k + 1, j + i1))
                                    {
