...
{
    monster(IMob.class, 70, Material.field_76249_a, false, false),
    creature(EntityAnimal.class, 10, Material.field_76249_a, true, true),
    ambient(EntityAmbientCreature.class, 15, Material.field_76249_a, true, false),
    waterCreature(EntityWaterMob.class, 5, Material.field_76244_g, true, false);
