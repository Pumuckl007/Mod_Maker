...
public class EntityLeashKnot extends EntityHanging
{
    ...
    public boolean func_130002_c(EntityPlayer p_130002_1_)
    {
        ...
        if (itemstack != null && itemstack.field_77993_c == Item.field_111214_ch.field_77779_bT && !this.field_70170_p.field_72995_K)
        {
            d0 = 7.0D;
    ...
    {
        int i = this.field_70170_p.func_72798_a(this.field_70523_b, this.field_70524_c, this.field_70521_d);
        return Block.field_71973_m[i] != null && Block.field_71973_m[i].func_71857_b() == 11;
    }
    ...
    {
        List list = p_110130_0_.func_72872_a(EntityLeashKnot.class, AxisAlignedBB.func_72332_a().func_72299_a((double)p_110130_1_ - 1.0D, (double)p_110130_2_ - 1.0D, (double)p_110130_3_ - 1.0D, (double)p_110130_1_ + 1.0D, (double)p_110130_2_ + 1.0D, (double)p_110130_3_ + 1.0D));
        Object object = null;
        ...
        if (list != null)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (entityleashknot.field_70523_b == p_110130_1_ && entityleashknot.field_70524_c == p_110130_2_ && entityleashknot.field_70521_d == p_110130_3_)
                {
                    return entityleashknot;
                }
            }
