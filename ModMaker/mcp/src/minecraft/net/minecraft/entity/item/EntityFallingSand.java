                ...
                if (this.field_70122_E)
                {
                    ...
                    if (this.field_70170_p.func_72798_a(i, j, k) != Block.field_72095_ac.field_71990_ca)
                    {
                        ...
                        if (!this.field_82157_e && this.field_70170_p.func_72931_a(this.field_70287_a, i, j, k, true, 1, (Entity)null, (ItemStack)null) && !BlockSand.func_72191_e_(this.field_70170_p, i, j - 1, k) && this.field_70170_p.func_72832_d(i, j, k, this.field_70287_a, this.field_70285_b, 3))
                        {
                            ...
                            {
                                TileEntity tileentity = this.field_70170_p.func_72796_p(i, j, k);

                                if (tileentity != null)
                                {
                                    NBTTagCompound nbttagcompound = new NBTTagCompound();
                                    tileentity.func_70310_b(nbttagcompound);
                                    Iterator iterator = this.field_98051_e.func_74758_c().iterator();

                                    while (iterator.hasNext())
                                    {
                                        NBTBase nbtbase = (NBTBase)iterator.next();

                                        if (!nbtbase.func_74740_e().equals("x") && !nbtbase.func_74740_e().equals("y") && !nbtbase.func_74740_e().equals("z"))
                                        {
        ...
        if (this.field_82155_f)
        {
            ...
            if (i > 0)
            {
                ...
                while (iterator.hasNext())
                {
                    ...
                    entity.func_70097_a(damagesource, (float)Math.min(MathHelper.func_76141_d((float)i * this.field_82158_h), this.field_82156_g));
                }
