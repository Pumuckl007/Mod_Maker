...
public class TileEntityPiston extends TileEntity
{
    ...
    private void func_70335_a(float p_70335_1_, float p_70335_2_)
    {
        ...
        AxisAlignedBB axisalignedbb = Block.field_72095_ac.func_72296_b(this.field_70331_k, this.field_70329_l, this.field_70330_m, this.field_70327_n, this.field_70348_a, p_70335_1_, this.field_70347_c);

        if (axisalignedbb != null)
        {
            List list = this.field_70331_k.func_72839_b((Entity)null, axisalignedbb);

            if (!list.isEmpty())
            {
                this.field_70349_h.addAll(list);
                Iterator iterator = this.field_70349_h.iterator();

                while (iterator.hasNext())
                {
                    Entity entity = (Entity)iterator.next();
                    entity.func_70091_d((double)(p_70335_2_ * (float)Facing.field_71586_b[this.field_70347_c]), (double)(p_70335_2_ * (float)Facing.field_71587_c[this.field_70347_c]), (double)(p_70335_2_ * (float)Facing.field_71585_d[this.field_70347_c]));
                }
