...
public class ScoreboardSaveData extends WorldSavedData
{
    ...
    protected void func_96498_a(NBTTagList p_96498_1_)
    {
        ...
        {
            NBTTagCompound nbttagcompound = (NBTTagCompound)p_96498_1_.func_74743_b(i);
            ...
            if (nbttagcompound.func_74764_b("AllowFriendlyFire"))
            {
                scoreplayerteam.func_96660_a(nbttagcompound.func_74767_n("AllowFriendlyFire"));
            }

            if (nbttagcompound.func_74764_b("SeeFriendlyInvisibles"))
            {
                scoreplayerteam.func_98300_b(nbttagcompound.func_74767_n("SeeFriendlyInvisibles"));
            }

            this.func_96502_a(scoreplayerteam, nbttagcompound.func_74761_m("Players"));
        }
    }
    ...
    protected void func_96502_a(ScorePlayerTeam p_96502_1_, NBTTagList p_96502_2_)
    {
        ...
        {
            this.field_96507_a.func_96521_a(((NBTTagString)p_96502_2_.func_74743_b(i)).field_74751_a, p_96502_1_);
        }
    }
    ...
    protected void func_96504_c(NBTTagCompound p_96504_1_)
    {
        for (int i = 0; i < 3; ++i)
        {
            if (p_96504_1_.func_74764_b("slot_" + i))
            {
    ...
    protected void func_96501_b(NBTTagList p_96501_1_)
    {
        ...
        {
            NBTTagCompound nbttagcompound = (NBTTagCompound)p_96501_1_.func_74743_b(i);
            ScoreObjectiveCriteria scoreobjectivecriteria = (ScoreObjectiveCriteria)ScoreObjectiveCriteria.field_96643_a.get(nbttagcompound.func_74779_i("CriteriaName"));
            ScoreObjective scoreobjective = this.field_96507_a.func_96535_a(nbttagcompound.func_74779_i("Name"), scoreobjectivecriteria);
    ...
    protected void func_96500_c(NBTTagList p_96500_1_)
    {
        ...
        {
            NBTTagCompound nbttagcompound = (NBTTagCompound)p_96500_1_.func_74743_b(i);
    ...
    protected void func_96497_d(NBTTagCompound p_96497_1_)
    {
        ...
        if (flag)
        {
            p_96497_1_.func_74766_a("DisplaySlots", nbttagcompound1);
        }
    }
