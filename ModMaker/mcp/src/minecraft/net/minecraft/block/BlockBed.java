...
public class BlockBed extends BlockDirectional
{
    ...
    public boolean func_71903_a(World p_71903_1_, int p_71903_2_, int p_71903_3_, int p_71903_4_, EntityPlayer p_71903_5_, int p_71903_6_, float p_71903_7_, float p_71903_8_, float p_71903_9_)
    {
        ...
        else
        {
            ...
            if (!func_72229_a_(i1))
            {
                ...
                p_71903_2_ += field_72230_a[j1][0];
                p_71903_4_ += field_72230_a[j1][1];
                ...
                i1 = p_71903_1_.func_72805_g(p_71903_2_, p_71903_3_, p_71903_4_);
            }
            ...
            {
                double d0 = (double)p_71903_2_ + 0.5D;
                double d1 = (double)p_71903_3_ + 0.5D;
                double d2 = (double)p_71903_4_ + 0.5D;
                p_71903_1_.func_94571_i(p_71903_2_, p_71903_3_, p_71903_4_);
                int k1 = func_72217_d(i1);
                p_71903_2_ += field_72230_a[k1][0];
                p_71903_4_ += field_72230_a[k1][1];

                if (p_71903_1_.func_72798_a(p_71903_2_, p_71903_3_, p_71903_4_) == this.field_71990_ca)
                {
                    p_71903_1_.func_94571_i(p_71903_2_, p_71903_3_, p_71903_4_);
                    d0 = (d0 + (double)p_71903_2_ + 0.5D) / 2.0D;
                    d1 = (d1 + (double)p_71903_3_ + 0.5D) / 2.0D;
                    d2 = (d2 + (double)p_71903_4_ + 0.5D) / 2.0D;
                }
    ...
    public Icon func_71858_a(int p_71858_1_, int p_71858_2_)
    {
        ...
        {
            int k = func_72217_d(p_71858_2_);
            int l = Direction.field_71584_h[k][p_71858_1_];
            int i1 = func_72229_a_(p_71858_2_) ? 1 : 0;
    ...
    public void func_71863_a(World p_71863_1_, int p_71863_2_, int p_71863_3_, int p_71863_4_, int p_71863_5_)
    {
        ...
        if (func_72229_a_(i1))
        {
            if (p_71863_1_.func_72798_a(p_71863_2_ - field_72230_a[j1][0], p_71863_3_, p_71863_4_ - field_72230_a[j1][1]) != this.field_71990_ca)
            {
                p_71863_1_.func_94571_i(p_71863_2_, p_71863_3_, p_71863_4_);
            }
        }
        else if (p_71863_1_.func_72798_a(p_71863_2_ + field_72230_a[j1][0], p_71863_3_, p_71863_4_ + field_72230_a[j1][1]) != this.field_71990_ca)
        {
            p_71863_1_.func_94571_i(p_71863_2_, p_71863_3_, p_71863_4_);
    ...
    {
        int l = p_72228_0_.func_72805_g(p_72228_1_, p_72228_2_, p_72228_3_);
        ...
        p_72228_0_.func_72921_c(p_72228_1_, p_72228_2_, p_72228_3_, l, 4);
    }

    public static ChunkCoordinates func_72226_b(World p_72226_0_, int p_72226_1_, int p_72226_2_, int p_72226_3_, int p_72226_4_)
    {
        int i1 = p_72226_0_.func_72805_g(p_72226_1_, p_72226_2_, p_72226_3_);
        int j1 = BlockDirectional.func_72217_d(i1);

        for (int k1 = 0; k1 <= 1; ++k1)
        {
            int l1 = p_72226_1_ - field_72230_a[j1][0] * k1 - 1;
            int i2 = p_72226_3_ - field_72230_a[j1][1] * k1 - 1;
            int j2 = l1 + 2;
            int k2 = i2 + 2;
            ...
            for (int l2 = l1; l2 <= j2; ++l2)
            {
                ...
                {
                    if (p_72226_0_.func_72797_t(l2, p_72226_2_ - 1, i3) && !p_72226_0_.func_72803_f(l2, p_72226_2_, i3).func_76218_k() && !p_72226_0_.func_72803_f(l2, p_72226_2_ + 1, i3).func_76218_k())
                    {
                        if (p_72226_4_ <= 0)
                        {
                            return new ChunkCoordinates(l2, p_72226_2_, i3);
                        }
    ...
    public void func_71846_a(World p_71846_1_, int p_71846_2_, int p_71846_3_, int p_71846_4_, int p_71846_5_, EntityPlayer p_71846_6_)
    {
        ...
        {
            int i1 = func_72217_d(p_71846_5_);
            p_71846_2_ -= field_72230_a[i1][0];
            p_71846_4_ -= field_72230_a[i1][1];
