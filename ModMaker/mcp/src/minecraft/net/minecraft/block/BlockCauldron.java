...
public class BlockCauldron extends Block
{
                ...
                else
                {
                    if (itemstack.field_77993_c == Item.field_77729_bt.field_77779_bT)
                    {
                        if (j1 > 0)
                        {
                            ...
                            p_71903_1_.func_72921_c(p_71903_2_, p_71903_3_, p_71903_4_, j1 - 1, 2);
                            p_71903_1_.func_96440_m(p_71903_2_, p_71903_3_, p_71903_4_, this.field_71990_ca);
                        }
                    }
                    else if (j1 > 0 && itemstack.func_77973_b() instanceof ItemArmor && ((ItemArmor)itemstack.func_77973_b()).func_82812_d() == EnumArmorMaterial.CLOTH)
                    {
    ...
    public void func_71892_f(World p_71892_1_, int p_71892_2_, int p_71892_3_, int p_71892_4_)
    {
        ...
        {
            int l = p_71892_1_.func_72805_g(p_71892_2_, p_71892_3_, p_71892_4_);

            if (l < 3)
            {
                p_71892_1_.func_72921_c(p_71892_2_, p_71892_3_, p_71892_4_, l + 1, 2);
            }
        }
    }
    ...
    {
        int i1 = p_94328_1_.func_72805_g(p_94328_2_, p_94328_3_, p_94328_4_);
