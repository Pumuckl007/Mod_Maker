...
public class BlockPistonMoving extends BlockContainer
{
    ...
    public void func_71914_a(World p_71914_1_, int p_71914_2_, int p_71914_3_, int p_71914_4_, int p_71914_5_, float p_71914_6_, int p_71914_7_)
    {
        ...
        {
            TileEntityPiston tileentitypiston = this.func_72295_d(p_71914_1_, p_71914_2_, p_71914_3_, p_71914_4_);
    ...
    {
        TileEntityPiston tileentitypiston = this.func_72295_d(p_71872_1_, p_71872_2_, p_71872_3_, p_71872_4_);
        ...
        else
        {
            ...
            return this.func_72296_b(p_71872_1_, p_71872_2_, p_71872_3_, p_71872_4_, tileentitypiston.func_70340_a(), f, tileentitypiston.func_70336_c());
        }
    }

    public void func_71902_a(IBlockAccess p_71902_1_, int p_71902_2_, int p_71902_3_, int p_71902_4_)
    {
        TileEntityPiston tileentitypiston = this.func_72295_d(p_71902_1_, p_71902_2_, p_71902_3_, p_71902_4_);
        ...
        if (tileentitypiston != null)
        {
            ...
            int l = tileentitypiston.func_70336_c();
            this.field_72026_ch = block.func_83009_v() - (double)((float)Facing.field_71586_b[l] * f);
            this.field_72023_ci = block.func_83008_x() - (double)((float)Facing.field_71587_c[l] * f);
            this.field_72024_cj = block.func_83005_z() - (double)((float)Facing.field_71585_d[l] * f);
            this.field_72021_ck = block.func_83007_w() - (double)((float)Facing.field_71586_b[l] * f);
            this.field_72022_cl = block.func_83010_y() - (double)((float)Facing.field_71587_c[l] * f);
            this.field_72019_cm = block.func_83006_A() - (double)((float)Facing.field_71585_d[l] * f);
        }
    }
    ...
    public AxisAlignedBB func_72296_b(World p_72296_1_, int p_72296_2_, int p_72296_3_, int p_72296_4_, int p_72296_5_, float p_72296_6_, int p_72296_7_)
    {
        if (p_72296_5_ != 0 && p_72296_5_ != this.field_71990_ca)
        {
            ...
            else
            {
                ...
                {
                    axisalignedbb.field_72340_a -= (double)((float)Facing.field_71586_b[p_72296_7_] * p_72296_6_);
                }
                else
                {
                    axisalignedbb.field_72336_d -= (double)((float)Facing.field_71586_b[p_72296_7_] * p_72296_6_);
                }

                if (Facing.field_71587_c[p_72296_7_] < 0)
                {
                    axisalignedbb.field_72338_b -= (double)((float)Facing.field_71587_c[p_72296_7_] * p_72296_6_);
                }
                else
                {
                    axisalignedbb.field_72337_e -= (double)((float)Facing.field_71587_c[p_72296_7_] * p_72296_6_);
                }

                if (Facing.field_71585_d[p_72296_7_] < 0)
                {
                    axisalignedbb.field_72339_c -= (double)((float)Facing.field_71585_d[p_72296_7_] * p_72296_6_);
                }
                else
                {
                    axisalignedbb.field_72334_f -= (double)((float)Facing.field_71585_d[p_72296_7_] * p_72296_6_);
                }
