...
public class BlockRedstoneRepeater extends BlockRedstoneLogic
{
    ...
    public boolean func_71903_a(World p_71903_1_, int p_71903_2_, int p_71903_3_, int p_71903_4_, EntityPlayer p_71903_5_, int p_71903_6_, float p_71903_7_, float p_71903_8_, float p_71903_9_)
    {
        ...
        int j1 = (i1 & 12) >> 2;
        j1 = j1 + 1 << 2 & 12;
        p_71903_1_.func_72921_c(p_71903_2_, p_71903_3_, p_71903_4_, j1 | i1 & 3, 3);
        return true;
    }
    ...
    public void func_71862_a(World p_71862_1_, int p_71862_2_, int p_71862_3_, int p_71862_4_, Random p_71862_5_)
    {
        if (this.field_72222_c)
        {
            ...
            double d1 = (double)((float)p_71862_3_ + 0.4F) + (double)(p_71862_5_.nextFloat() - 0.5F) * 0.2D;
            ...
            p_71862_1_.func_72869_a("reddust", d0 + d3, d1, d2 + d4, 0.0D, 0.0D, 0.0D);
        }
    }
