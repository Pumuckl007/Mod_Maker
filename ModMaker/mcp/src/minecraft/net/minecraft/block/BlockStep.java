...
public class BlockStep extends BlockHalfSlab
{
    ...
    public Icon func_71858_a(int p_71858_1_, int p_71858_2_)
    {
        ...
        return k == 0 ? (p_71858_1_ != 1 && p_71858_1_ != 0 ? this.field_94433_b : this.field_94336_cN) : (k == 1 ? Block.field_71957_Q.func_71851_a(p_71858_1_) : (k == 2 ? Block.field_71988_x.func_71851_a(p_71858_1_) : (k == 3 ? Block.field_71978_w.func_71851_a(p_71858_1_) : (k == 4 ? Block.field_72081_al.func_71851_a(p_71858_1_) : (k == 5 ? Block.field_72007_bm.func_71858_a(p_71858_1_, 0) : (k == 6 ? Block.field_72033_bA.func_71851_a(1) : (k == 7 ? Block.field_94339_ct.func_71851_a(p_71858_1_) : this.field_94336_cN)))))));
    }
    ...
    public void func_71879_a(int p_71879_1_, CreativeTabs p_71879_2_, List p_71879_3_)
    {
        if (p_71879_1_ != Block.field_72085_aj.field_71990_ca)
        {
            for (int j = 0; j <= 7; ++j)
            {
                if (j != 2)
                {
                    p_71879_3_.add(new ItemStack(p_71879_1_, 1, j));
                }
            }
        }
    }
