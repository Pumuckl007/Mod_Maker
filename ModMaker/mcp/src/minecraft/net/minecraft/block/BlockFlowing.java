...
public class BlockFlowing extends BlockFluid
{
    ...
    private void func_72205_l(World p_72205_1_, int p_72205_2_, int p_72205_3_, int p_72205_4_)
    {
        ...
        p_72205_1_.func_72832_d(p_72205_2_, p_72205_3_, p_72205_4_, this.field_71990_ca + 1, l, 2);
    }
    ...
    public void func_71847_b(World p_71847_1_, int p_71847_2_, int p_71847_3_, int p_71847_4_, Random p_71847_5_)
    {
        ...
        boolean flag = true;
        int i1 = this.func_71859_p_(p_71847_1_);
        int j1;
        ...
        if (l > 0)
        {
            ...
            int k1 = this.func_72211_e(p_71847_1_, p_71847_2_ - 1, p_71847_3_, p_71847_4_, b1);
            k1 = this.func_72211_e(p_71847_1_, p_71847_2_ + 1, p_71847_3_, p_71847_4_, k1);
            k1 = this.func_72211_e(p_71847_1_, p_71847_2_, p_71847_3_, p_71847_4_ - 1, k1);
            k1 = this.func_72211_e(p_71847_1_, p_71847_2_, p_71847_3_, p_71847_4_ + 1, k1);
            j1 = k1 + b0;
            ...
            {
                int l1 = this.func_72198_f_(p_71847_1_, p_71847_2_, p_71847_3_ + 1, p_71847_4_);
            ...
            if (this.field_72018_cp == Material.field_76256_h && l < 8 && j1 < 8 && j1 > l && p_71847_5_.nextInt(4) != 0)
            {
                i1 *= 4;
            }
            ...
            else
            {
                ...
                {
                    p_71847_1_.func_72921_c(p_71847_2_, p_71847_3_, p_71847_4_, j1, 2);
                    p_71847_1_.func_72836_a(p_71847_2_, p_71847_3_, p_71847_4_, this.field_71990_ca, i1);
