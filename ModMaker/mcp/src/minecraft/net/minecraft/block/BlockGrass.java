...
public class BlockGrass extends Block
{
    ...
    public Icon func_71895_b(IBlockAccess p_71895_1_, int p_71895_2_, int p_71895_3_, int p_71895_4_, int p_71895_5_)
    {
        ...
        else
        {
            ...
            return material != Material.field_76259_v && material != Material.field_76258_w ? this.field_94336_cN : this.field_94435_b;
        }
    }
    ...
    public int func_71920_b(IBlockAccess p_71920_1_, int p_71920_2_, int p_71920_3_, int p_71920_4_)
    {
        ...
        for (int k1 = -1; k1 <= 1; ++k1)
        {
            ...
            {
                int i2 = p_71920_1_.func_72807_a(p_71920_2_ + l1, p_71920_4_ + k1).func_76737_k();
                l += (i2 & 16711680) >> 16;
                i1 += (i2 & 65280) >> 8;
                j1 += i2 & 255;
            }
