...
public class BlockTripWire extends Block
{
    ...
    {
        int j1 = p_72148_1_ + Direction.field_71583_a[p_72148_5_];
        int k1 = p_72148_3_ + Direction.field_71581_b[p_72148_5_];
        int l1 = p_72148_0_.func_72798_a(j1, p_72148_2_, k1);
        boolean flag = (p_72148_4_ & 2) == 2;
        int i2;

        if (l1 == Block.field_72064_bT.field_71990_ca)
        {
            i2 = p_72148_0_.func_72805_g(j1, p_72148_2_, k1);
            int j2 = i2 & 3;
            return j2 == Direction.field_71580_e[p_72148_5_];
        }
        else if (l1 == Block.field_72062_bU.field_71990_ca)
        {
            i2 = p_72148_0_.func_72805_g(j1, p_72148_2_, k1);
