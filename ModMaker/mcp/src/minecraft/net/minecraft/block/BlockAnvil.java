...
public class BlockAnvil extends BlockSand
{
    ...
    public Icon func_71858_a(int p_71858_1_, int p_71858_2_)
    {
        ...
        {
            int k = (p_71858_2_ >> 2) % this.field_94432_cP.length;
    ...
    public void func_94332_a(IconRegister p_94332_1_)
    {
        ...
        {
            this.field_94432_cP[i] = p_94332_1_.func_94245_a(field_94431_cO[i]);
        }
    }
    ...
    public void func_71860_a(World p_71860_1_, int p_71860_2_, int p_71860_3_, int p_71860_4_, EntityLivingBase p_71860_5_, ItemStack p_71860_6_)
    {
        ...
        int i1 = p_71860_1_.func_72805_g(p_71860_2_, p_71860_3_, p_71860_4_) >> 2;
        ++l;
        l %= 4;

        if (l == 0)
        {
            p_71860_1_.func_72921_c(p_71860_2_, p_71860_3_, p_71860_4_, 2 | i1 << 2, 2);
        }

        if (l == 1)
        {
            p_71860_1_.func_72921_c(p_71860_2_, p_71860_3_, p_71860_4_, 3 | i1 << 2, 2);
        }

        if (l == 2)
        {
            p_71860_1_.func_72921_c(p_71860_2_, p_71860_3_, p_71860_4_, 0 | i1 << 2, 2);
        }

        if (l == 3)
        {
            p_71860_1_.func_72921_c(p_71860_2_, p_71860_3_, p_71860_4_, 1 | i1 << 2, 2);
        }
    }
