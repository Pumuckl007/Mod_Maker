...
public class BlockFlowerPot extends Block
{
    ...
    public void func_71919_f()
    {
        float f = 0.375F;
        float f1 = f / 2.0F;
        this.func_71905_a(0.5F - f1, 0.0F, 0.5F - f1, 0.5F + f1, f, 0.5F + f1);
    }
    ...
    public boolean func_71903_a(World p_71903_1_, int p_71903_2_, int p_71903_3_, int p_71903_4_, EntityPlayer p_71903_5_, int p_71903_6_, float p_71903_7_, float p_71903_8_, float p_71903_9_)
    {
        ...
        {
            int i1 = func_82530_a(itemstack);

            if (i1 > 0)
            {
                p_71903_1_.func_72921_c(p_71903_2_, p_71903_3_, p_71903_4_, i1, 2);

                if (!p_71903_5_.field_71075_bZ.field_75098_d && --itemstack.field_77994_a <= 0)
                {
    ...
    {
        ItemStack itemstack = func_82531_c(p_71922_1_.func_72805_g(p_71922_2_, p_71922_3_, p_71922_4_));
        return itemstack == null ? Item.field_82796_bJ.field_77779_bT : itemstack.field_77993_c;
    }

    public int func_71873_h(World p_71873_1_, int p_71873_2_, int p_71873_3_, int p_71873_4_)
    {
        ItemStack itemstack = func_82531_c(p_71873_1_.func_72805_g(p_71873_2_, p_71873_3_, p_71873_4_));
        return itemstack == null ? Item.field_82796_bJ.field_77779_bT : itemstack.func_77960_j();
    }
    ...
    public void func_71914_a(World p_71914_1_, int p_71914_2_, int p_71914_3_, int p_71914_4_, int p_71914_5_, float p_71914_6_, int p_71914_7_)
    {
        ...
        if (p_71914_5_ > 0)
        {
            ItemStack itemstack = func_82531_c(p_71914_5_);
    ...
    {
        int i = p_82530_0_.func_77973_b().field_77779_bT;

        if (i == Block.field_72107_ae.field_71990_ca)
        {
            return 1;
        }
        else if (i == Block.field_72097_ad.field_71990_ca)
        {
            return 2;
        }
        else if (i == Block.field_72038_aV.field_71990_ca)
        {
            return 9;
        }
        else if (i == Block.field_72109_af.field_71990_ca)
        {
            return 8;
        }
        else if (i == Block.field_72103_ag.field_71990_ca)
        {
            return 7;
        }
        else if (i == Block.field_71961_Y.field_71990_ca)
        {
            return 10;
        }
        else
