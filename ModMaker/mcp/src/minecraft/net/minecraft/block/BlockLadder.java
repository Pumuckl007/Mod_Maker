...
public class BlockLadder extends Block
{
    ...
    public int func_85104_a(World p_85104_1_, int p_85104_2_, int p_85104_3_, int p_85104_4_, int p_85104_5_, float p_85104_6_, float p_85104_7_, float p_85104_8_, int p_85104_9_)
    {
        ...
        if ((j1 == 0 || p_85104_5_ == 3) && p_85104_1_.func_72809_s(p_85104_2_, p_85104_3_, p_85104_4_ - 1))
        {
            j1 = 3;
        }

        if ((j1 == 0 || p_85104_5_ == 4) && p_85104_1_.func_72809_s(p_85104_2_ + 1, p_85104_3_, p_85104_4_))
        {
            j1 = 4;
        }

        if ((j1 == 0 || p_85104_5_ == 5) && p_85104_1_.func_72809_s(p_85104_2_ - 1, p_85104_3_, p_85104_4_))
        {
            j1 = 5;
        }
    ...
    public void func_71863_a(World p_71863_1_, int p_71863_2_, int p_71863_3_, int p_71863_4_, int p_71863_5_)
    {
        ...
        if (i1 == 2 && p_71863_1_.func_72809_s(p_71863_2_, p_71863_3_, p_71863_4_ + 1))
        {
            flag = true;
        }

        if (i1 == 3 && p_71863_1_.func_72809_s(p_71863_2_, p_71863_3_, p_71863_4_ - 1))
        {
            flag = true;
        }

        if (i1 == 4 && p_71863_1_.func_72809_s(p_71863_2_ + 1, p_71863_3_, p_71863_4_))
        {
            flag = true;
        }

        if (i1 == 5 && p_71863_1_.func_72809_s(p_71863_2_ - 1, p_71863_3_, p_71863_4_))
        {
            flag = true;
        }
