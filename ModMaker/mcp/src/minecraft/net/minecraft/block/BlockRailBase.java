...
public abstract class BlockRailBase extends Block
{
    ...
    public void func_71863_a(World p_71863_1_, int p_71863_2_, int p_71863_3_, int p_71863_4_, int p_71863_5_)
    {
        if (!p_71863_1_.field_72995_K)
        {
            ...
            if (j1 == 2 && !p_71863_1_.func_72797_t(p_71863_2_ + 1, p_71863_3_, p_71863_4_))
            {
                flag = true;
            }

            if (j1 == 3 && !p_71863_1_.func_72797_t(p_71863_2_ - 1, p_71863_3_, p_71863_4_))
            {
                flag = true;
            }

            if (j1 == 4 && !p_71863_1_.func_72797_t(p_71863_2_, p_71863_3_, p_71863_4_ - 1))
            {
                flag = true;
            }

            if (j1 == 5 && !p_71863_1_.func_72797_t(p_71863_2_, p_71863_3_, p_71863_4_ + 1))
            {
                flag = true;
            }
            ...
            {
                this.func_94358_a(p_71863_1_, p_71863_2_, p_71863_3_, p_71863_4_, i1, j1, p_71863_5_);
            }
        }
    }
