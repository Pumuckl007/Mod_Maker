...
public class BlockTNT extends Block
{
    ...
    public void func_71867_k(World p_71867_1_, int p_71867_2_, int p_71867_3_, int p_71867_4_, Explosion p_71867_5_)
    {
        ...
        {
            EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(p_71867_1_, (double)((float)p_71867_2_ + 0.5F), (double)((float)p_71867_3_ + 0.5F), (double)((float)p_71867_4_ + 0.5F), p_71867_5_.func_94613_c());
    ...
    public void func_94391_a(World p_94391_1_, int p_94391_2_, int p_94391_3_, int p_94391_4_, int p_94391_5_, EntityLivingBase p_94391_6_)
    {
        if (!p_94391_1_.field_72995_K)
        {
            if ((p_94391_5_ & 1) == 1)
            {
                EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(p_94391_1_, (double)((float)p_94391_2_ + 0.5F), (double)((float)p_94391_3_ + 0.5F), (double)((float)p_94391_4_ + 0.5F), p_94391_6_);
                p_94391_1_.func_72838_d(entitytntprimed);
                p_94391_1_.func_72956_a(entitytntprimed, "random.fuse", 1.0F, 1.0F);
            }
        }
    }
    ...
    public void func_71869_a(World p_71869_1_, int p_71869_2_, int p_71869_3_, int p_71869_4_, Entity p_71869_5_)
    {
        ...
        {
            EntityArrow entityarrow = (EntityArrow)p_71869_5_;

            if (entityarrow.func_70027_ad())
            {
                this.func_94391_a(p_71869_1_, p_71869_2_, p_71869_3_, p_71869_4_, 1, entityarrow.field_70250_c instanceof EntityLivingBase ? (EntityLivingBase)entityarrow.field_70250_c : null);
