...
public class BlockVine extends Block
{
    ...
    public void func_71902_a(IBlockAccess p_71902_1_, int p_71902_2_, int p_71902_3_, int p_71902_4_)
    {
        ...
        this.func_71905_a(f1, f2, f3, f4, f5, f6);
    }
    ...
    private boolean func_72150_l(World p_72150_1_, int p_72150_2_, int p_72150_3_, int p_72150_4_)
    {
        ...
        else
        {
            if (i1 != l)
            {
                p_72150_1_.func_72921_c(p_72150_2_, p_72150_3_, p_72150_4_, i1, 2);
            }
            ...
            else
            {
                ...
                if (j1 >= 2 && j1 <= 5 && (i1 & 1 << k1) == 0)
                {
                    ...
                    if (l1 != 0 && Block.field_71973_m[l1] != null)
                    {
                        ...
                        {
                            p_71847_1_.func_72921_c(p_71847_2_, p_71847_3_, p_71847_4_, i1 | 1 << k1, 2);
                        }
                    }
                    else
                    {
                ...
                else if (p_71847_3_ > 1)
                {
                    ...
                    else if (l1 == this.field_71990_ca)
                    {
                        ...
                        if (j2 != (j2 | i2))
                        {
                            p_71847_1_.func_72921_c(p_71847_2_, p_71847_3_ - 1, p_71847_4_, j2 | i2, 2);
                        }
                    }
                }
            }
