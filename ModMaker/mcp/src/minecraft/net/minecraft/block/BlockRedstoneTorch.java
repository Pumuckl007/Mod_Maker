...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    public void func_71862_a(World p_71862_1_, int p_71862_2_, int p_71862_3_, int p_71862_4_, Random p_71862_5_)
    {
        if (this.field_72130_a)
        {
            ...
            double d0 = (double)((float)p_71862_2_ + 0.5F) + (double)(p_71862_5_.nextFloat() - 0.5F) * 0.2D;
            double d1 = (double)((float)p_71862_3_ + 0.7F) + (double)(p_71862_5_.nextFloat() - 0.5F) * 0.2D;
            double d2 = (double)((float)p_71862_4_ + 0.5F) + (double)(p_71862_5_.nextFloat() - 0.5F) * 0.2D;
            double d3 = 0.2199999988079071D;
            double d4 = 0.27000001072883606D;

            if (l == 1)
            {
                p_71862_1_.func_72869_a("reddust", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            }
            else if (l == 2)
            {
                p_71862_1_.func_72869_a("reddust", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            ...
            {
                p_71862_1_.func_72869_a("reddust", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
            }
            else if (l == 4)
            {
                p_71862_1_.func_72869_a("reddust", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
            ...
            {
                p_71862_1_.func_72869_a("reddust", d0, d1, d2, 0.0D, 0.0D, 0.0D);
            }
        }
    }
