...
public class Block
{
    ...
    {
        float f = this.func_71934_m(p_71908_2_, p_71908_3_, p_71908_4_, p_71908_5_);
        return f < 0.0F ? 0.0F : (!p_71908_1_.func_71062_b(this) ? p_71908_1_.func_71055_a(this, false) / f / 100.0F : p_71908_1_.func_71055_a(this, true) / f / 30.0F);
    }
    ...
    public void func_71914_a(World p_71914_1_, int p_71914_2_, int p_71914_3_, int p_71914_4_, int p_71914_5_, float p_71914_6_, int p_71914_7_)
    {
        ...
        {
            int j1 = this.func_71910_a(p_71914_7_, p_71914_1_.field_73012_v);
            ...
            for (int k1 = 0; k1 < j1; ++k1)
            {
                if (p_71914_1_.field_73012_v.nextFloat() <= p_71914_6_)
                {
                    ...
                    if (l1 > 0)
                    {
                        this.func_71929_a(p_71914_1_, p_71914_2_, p_71914_3_, p_71914_4_, new ItemStack(l1, 1, this.func_71899_b(p_71914_5_)));
                    }
                }
            }
        }
    ...
    protected void func_71929_a(World p_71929_1_, int p_71929_2_, int p_71929_3_, int p_71929_4_, ItemStack p_71929_5_)
    {
        ...
        {
            float f = 0.7F;
            double d0 = (double)(p_71929_1_.field_73012_v.nextFloat() * f) + (double)(1.0F - f) * 0.5D;
            ...
            EntityItem entityitem = new EntityItem(p_71929_1_, (double)p_71929_2_ + d0, (double)p_71929_3_ + d1, (double)p_71929_4_ + d2, p_71929_5_);
    ...
    protected void func_71923_g(World p_71923_1_, int p_71923_2_, int p_71923_3_, int p_71923_4_, int p_71923_5_)
    {
        if (!p_71923_1_.field_72995_K)
        {
            while (p_71923_5_ > 0)
            {
                int i1 = EntityXPOrb.func_70527_a(p_71923_5_);
                p_71923_5_ -= i1;
                p_71923_1_.func_72838_d(new EntityXPOrb(p_71923_1_, (double)p_71923_2_ + 0.5D, (double)p_71923_3_ + 0.5D, (double)p_71923_4_ + 0.5D, i1));
            }
        }
    }
    ...
    public boolean func_71930_b(World p_71930_1_, int p_71930_2_, int p_71930_3_, int p_71930_4_)
    {
        ...
        return l == 0 || field_71973_m[l].field_72018_cp.func_76222_j();
    }
    ...
    protected ItemStack func_71880_c_(int p_71880_1_)
    {
        ...
        return new ItemStack(this.field_71990_ca, 1, j);
    }
