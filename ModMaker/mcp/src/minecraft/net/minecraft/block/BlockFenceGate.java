...
public class BlockFenceGate extends BlockDirectional
{
    ...
    {
        int l = (MathHelper.func_76128_c((double)(p_71860_5_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3) % 4;
    ...
    public boolean func_71903_a(World p_71903_1_, int p_71903_2_, int p_71903_3_, int p_71903_4_, EntityPlayer p_71903_5_, int p_71903_6_, float p_71903_7_, float p_71903_8_, float p_71903_9_)
    {
        ...
        if (func_72224_c(i1))
        {
            p_71903_1_.func_72921_c(p_71903_2_, p_71903_3_, p_71903_4_, i1 & -5, 2);
        }
        else
        {
            int j1 = (MathHelper.func_76128_c((double)(p_71903_5_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3) % 4;
    ...
    public void func_71863_a(World p_71863_1_, int p_71863_2_, int p_71863_3_, int p_71863_4_, int p_71863_5_)
    {
        if (!p_71863_1_.field_72995_K)
        {
            ...
            {
                if (flag && !func_72224_c(i1))
                {
                    p_71863_1_.func_72921_c(p_71863_2_, p_71863_3_, p_71863_4_, i1 | 4, 2);
                    p_71863_1_.func_72889_a((EntityPlayer)null, 1003, p_71863_2_, p_71863_3_, p_71863_4_, 0);
                }
                else if (!flag && func_72224_c(i1))
                {
                    p_71863_1_.func_72921_c(p_71863_2_, p_71863_3_, p_71863_4_, i1 & -5, 2);
                    p_71863_1_.func_72889_a((EntityPlayer)null, 1003, p_71863_2_, p_71863_3_, p_71863_4_, 0);
                }
            }
        }
