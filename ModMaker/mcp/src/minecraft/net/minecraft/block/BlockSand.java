...
public class BlockSand extends Block
{
    ...
    private void func_72190_l(World p_72190_1_, int p_72190_2_, int p_72190_3_, int p_72190_4_)
    {
        if (func_72191_e_(p_72190_1_, p_72190_2_, p_72190_3_ - 1, p_72190_4_) && p_72190_3_ >= 0)
        {
            ...
            if (!field_72192_a && p_72190_1_.func_72904_c(p_72190_2_ - b0, p_72190_3_ - b0, p_72190_4_ - b0, p_72190_2_ + b0, p_72190_3_ + b0, p_72190_4_ + b0))
            {
                if (!p_72190_1_.field_72995_K)
                {
                    EntityFallingSand entityfallingsand = new EntityFallingSand(p_72190_1_, (double)((float)p_72190_2_ + 0.5F), (double)((float)p_72190_3_ + 0.5F), (double)((float)p_72190_4_ + 0.5F), this.field_71990_ca, p_72190_1_.func_72805_g(p_72190_2_, p_72190_3_, p_72190_4_));
                    this.func_82520_a(entityfallingsand);
    ...
    {
        int l = p_72191_0_.func_72798_a(p_72191_1_, p_72191_2_, p_72191_3_);

        if (l == 0)
        {
            return true;
        }
        else if (l == Block.field_72067_ar.field_71990_ca)
        {
            return true;
        }
        else
