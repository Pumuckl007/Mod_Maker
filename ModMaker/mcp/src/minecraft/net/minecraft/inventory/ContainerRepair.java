...
public class ContainerRepair extends Container
{
    ...
    public ContainerRepair(InventoryPlayer p_i1800_1_, World p_i1800_2_, int p_i1800_3_, int p_i1800_4_, int p_i1800_5_, EntityPlayer p_i1800_6_)
    {
        ...
        for (l = 0; l < 3; ++l)
        {
            ...
            {
                this.func_75146_a(new Slot(p_i1800_1_, i1 + l * 9 + 9, 8 + i1 * 18, 84 + l * 18));
            }
        }

        for (l = 0; l < 9; ++l)
        {
            this.func_75146_a(new Slot(p_i1800_1_, l, 8 + l * 18, 142));
        }
    }
            ...
            if (itemstack2 != null)
            {
                ...
                else
                {
                    ...
                    while (iterator.hasNext())
                    {
                        ...
                        if (this.field_82855_n.field_71075_bZ.field_75098_d || itemstack.field_77993_c == ItemEnchantedBook.field_92105_bW.field_77779_bT)
                        {
                            flag1 = true;
                        }
    ...
    public void func_82850_a(String p_82850_1_)
    {
        ...
        if (this.func_75139_a(2).func_75216_d())
        {
            ...
            {
                itemstack.func_82834_c(this.field_82857_m);
            }
        }
