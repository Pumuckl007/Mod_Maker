...
class ContainerRepairINNER2 extends Slot
{
    ...
    public void func_82870_a(EntityPlayer p_82870_1_, ItemStack p_82870_2_)
    {
        ...
        {
            ItemStack itemstack1 = ContainerRepair.func_82851_a(this.field_135068_e).func_70301_a(1);

            if (itemstack1 != null && itemstack1.field_77994_a > ContainerRepair.func_82849_b(this.field_135068_e))
            {
                itemstack1.field_77994_a -= ContainerRepair.func_82849_b(this.field_135068_e);
                ContainerRepair.func_82851_a(this.field_135068_e).func_70299_a(1, itemstack1);
            }
            else
            {
        ...
        {
            int i = this.field_135071_a.func_72805_g(this.field_135069_b, this.field_135070_c, this.field_135067_d);
            int j = i & 3;
            int k = i >> 2;
            ++k;
            ...
            {
                this.field_135071_a.func_72921_c(this.field_135069_b, this.field_135070_c, this.field_135067_d, j | k << 2, 2);
