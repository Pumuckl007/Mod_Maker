                ...
                if (!this.field_94537_h.isEmpty())
                {
                    ...
                    while (iterator.hasNext())
                    {
                        ...
                        if (slot1 != null && func_94527_a(slot1, inventoryplayer.func_70445_o(), true) && slot1.func_75214_a(inventoryplayer.func_70445_o()) && inventoryplayer.func_70445_o().field_77994_a >= this.field_94537_h.size() && this.func_94531_b(slot1))
                        {
                            ...
                            if (itemstack2.field_77994_a > slot1.func_75219_a())
                            {
                                itemstack2.field_77994_a = slot1.func_75219_a();
                            }
        ...
        else
        {
            ...
            if ((p_75144_3_ == 0 || p_75144_3_ == 1) && (p_75144_2_ == 0 || p_75144_2_ == 1))
            {
                ...
                else if (p_75144_3_ == 1)
                {
                    ...
                    if (slot2 != null && slot2.func_82869_a(p_75144_4_))
                    {
                        ...
                        if (itemstack1 != null)
                        {
                            l = itemstack1.field_77993_c;
                            itemstack = itemstack1.func_77946_l();

                            if (slot2 != null && slot2.func_75211_c() != null && slot2.func_75211_c().field_77993_c == l)
                            {
                ...
                else
                {
                    ...
                    if (slot2 != null)
                    {
                        ...
                        if (itemstack1 == null)
                        {
                            ...
                            {
                                k1 = p_75144_2_ == 0 ? itemstack4.field_77994_a : 1;
                        ...
                        else if (slot2.func_82869_a(p_75144_4_))
                        {
                            if (itemstack4 == null)
                            {
                                k1 = p_75144_2_ == 0 ? itemstack1.field_77994_a : (itemstack1.field_77994_a + 1) / 2;
                                itemstack3 = slot2.func_75209_a(k1);
                            ...
                            {
                                if (itemstack1.field_77993_c == itemstack4.field_77993_c && itemstack1.func_77960_j() == itemstack4.func_77960_j() && ItemStack.func_77970_a(itemstack1, itemstack4))
                                {
                                    k1 = p_75144_2_ == 0 ? itemstack4.field_77994_a : 1;

                                    if (k1 > slot2.func_75219_a() - itemstack1.field_77994_a)
                                    {
                                        k1 = slot2.func_75219_a() - itemstack1.field_77994_a;
                                    }

                                    if (k1 > itemstack4.func_77976_d() - itemstack1.field_77994_a)
                                    {
                                        k1 = itemstack4.func_77976_d() - itemstack1.field_77994_a;
                                    }

                                    itemstack4.func_77979_a(k1);
                            ...
                            else if (itemstack1.field_77993_c == itemstack4.field_77993_c && itemstack4.func_77976_d() > 1 && (!itemstack1.func_77981_g() || itemstack1.func_77960_j() == itemstack4.func_77960_j()) && ItemStack.func_77970_a(itemstack1, itemstack4))
                            {
                                k1 = itemstack1.field_77994_a;

                                if (k1 > 0 && k1 + itemstack4.field_77994_a <= itemstack4.func_77976_d())
                                {
                                    itemstack4.field_77994_a += k1;
                                    itemstack1 = slot2.func_75209_a(k1);
            ...
            else if (p_75144_3_ == 2 && p_75144_2_ >= 0 && p_75144_2_ < 9)
            {
                ...
                if (slot2.func_82869_a(p_75144_4_))
                {
                    ...
                    boolean flag = itemstack1 == null || slot2.field_75224_c == inventoryplayer && slot2.func_75214_a(itemstack1);
                    k1 = -1;
                    ...
                    if (slot2.func_75216_d() && flag)
                    {
                        ...
                        inventoryplayer.func_70299_a(p_75144_2_, itemstack3.func_77946_l());

                        if ((slot2.field_75224_c != inventoryplayer || !slot2.func_75214_a(itemstack1)) && itemstack1 != null)
                        {
                            if (k1 > -1)
                            {
                    ...
                    else if (!slot2.func_75216_d() && itemstack1 != null && slot2.func_75214_a(itemstack1))
                    {
            ...
            else if (p_75144_3_ == 3 && p_75144_4_.field_71075_bZ.field_75098_d && inventoryplayer.func_70445_o() == null && p_75144_1_ >= 0)
            {
                ...
                {
                    itemstack1 = slot2.func_75211_c().func_77946_l();
            ...
            else if (p_75144_3_ == 4 && inventoryplayer.func_70445_o() == null && p_75144_1_ >= 0)
            {
                ...
                {
                    itemstack1 = slot2.func_75209_a(p_75144_2_ == 0 ? 1 : slot2.func_75211_c().field_77994_a);
                    slot2.func_82870_a(p_75144_4_, itemstack1);
                    p_75144_4_.func_71021_b(itemstack1);
                }
            }
            else if (p_75144_3_ == 6 && p_75144_1_ >= 0)
            {
                ...
                if (itemstack1 != null && (slot2 == null || !slot2.func_75216_d() || !slot2.func_82869_a(p_75144_4_)))
                {
                    l = p_75144_2_ == 0 ? 0 : this.field_75151_b.size() - 1;
                    k1 = p_75144_2_ == 0 ? 1 : -1;

                    for (int l1 = 0; l1 < 2; ++l1)
                    {
                        for (int i2 = l; i2 >= 0 && i2 < this.field_75151_b.size() && itemstack1.field_77994_a < itemstack1.func_77976_d(); i2 += k1)
                        {
                            Slot slot3 = (Slot)this.field_75151_b.get(i2);

                            if (slot3.func_75216_d() && func_94527_a(slot3, itemstack1, true) && slot3.func_82869_a(p_75144_4_) && this.func_94530_a(itemstack1, slot3) && (l1 != 0 || slot3.func_75211_c().field_77994_a != slot3.func_75211_c().func_77976_d()))
                            {
                                int j2 = Math.min(itemstack1.func_77976_d() - itemstack1.field_77994_a, slot3.func_75211_c().field_77994_a);
                                ItemStack itemstack5 = slot3.func_75209_a(j2);
                                itemstack1.field_77994_a += j2;
