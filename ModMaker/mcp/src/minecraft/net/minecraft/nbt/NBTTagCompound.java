...
public class NBTTagCompound extends NBTBase
{
    ...
    {
        Iterator iterator = this.field_74784_a.values().iterator();

        while (iterator.hasNext())
        {
            NBTBase nbtbase = (NBTBase)iterator.next();
            NBTBase.func_74731_a(nbtbase, p_74734_1_);
        }
    ...
    void func_74735_a(DataInput p_74735_1_, int p_74735_2_) throws IOException
    {
        ...
        else
        {
            ...
            while ((nbtbase = NBTBase.func_130104_b(p_74735_1_, p_74735_2_ + 1)).func_74732_a() != 0)
            {
                this.field_74784_a.put(nbtbase.func_74740_e(), nbtbase);
            }
        }
    }
    ...
    public byte func_74771_c(String p_74771_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74771_1_, 1, classcastexception));
        }
    }
    ...
    public short func_74765_d(String p_74765_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74765_1_, 2, classcastexception));
        }
    }
    ...
    public int func_74762_e(String p_74762_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74762_1_, 3, classcastexception));
        }
    }
    ...
    public long func_74763_f(String p_74763_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74763_1_, 4, classcastexception));
        }
    }
    ...
    public float func_74760_g(String p_74760_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74760_1_, 5, classcastexception));
        }
    }
    ...
    public double func_74769_h(String p_74769_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74769_1_, 6, classcastexception));
        }
    }
    ...
    public String func_74779_i(String p_74779_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74779_1_, 8, classcastexception));
        }
    }
    ...
    public NBTTagList func_74761_m(String p_74761_1_)
    {
        ...
        {
            throw new ReportedException(this.func_82581_a(p_74761_1_, 9, classcastexception));
        }
    }
    ...
    private CrashReport func_82581_a(String p_82581_1_, int p_82581_2_, ClassCastException p_82581_3_)
    {
        ...
        crashreportcategory.func_71500_a("Tag type found", new CallableTagCompound1(this, p_82581_1_));
        crashreportcategory.func_71500_a("Tag type expected", new CallableTagCompound2(this, p_82581_2_));
        crashreportcategory.func_71507_a("Tag name", p_82581_1_);

        if (this.func_74740_e() != null && this.func_74740_e().length() > 0)
        {
            crashreportcategory.func_71507_a("Tag parent", this.func_74740_e());
        }
    ...
    {
        NBTTagCompound nbttagcompound = new NBTTagCompound(this.func_74740_e());
