...
public class IntegratedServer extends MinecraftServer
{
    ...
    protected void func_71247_a(String p_71247_1_, String p_71247_2_, long p_71247_3_, WorldType p_71247_5_, String p_71247_6_)
    {
        ...
        for (int j = 0; j < this.field_71305_c.length; ++j)
        {
            ...
            if (j == 0)
            {
                ...
                {
                    this.field_71305_c[j] = new WorldServer(this, isavehandler, p_71247_2_, b0, this.field_71350_m, this.field_71304_b, this.func_98033_al());
                }
            }
            else
            {
                this.field_71305_c[j] = new WorldServerMulti(this, isavehandler, p_71247_2_, b0, this.field_71350_m, this.field_71305_c[0], this.field_71304_b, this.func_98033_al());
            }
    ...
    public String func_71206_a(EnumGameType p_71206_1_, boolean p_71206_2_)
    {
        try
        {
            String s = this.field_71347_n.func_71755_c();
            this.func_98033_al().func_98233_a("Started on " + s);
            this.field_71346_p = true;
            this.field_71345_q = new ThreadLanServerPing(this.func_71273_Y(), s);
