...
public class IntegratedServerListenThread extends NetworkListenThread
{
    ...
    public String func_71755_c() throws IOException
    {
        if (this.field_71757_g == null)
        {
            ...
            try
            {
                this.field_71757_g = new ServerListenThread(this, (InetAddress)null, i);
    ...
    public void func_71747_b()
    {
        ...
        {
            EntityPlayerMP entityplayermp = this.func_71753_e().func_71203_ab().func_72366_a(this.field_71759_e);

            if (entityplayermp != null)
            {
                this.field_71760_c.func_74434_a(this.field_71758_d);
                this.field_71756_f = true;
                this.func_71753_e().func_71203_ab().func_72355_a(this.field_71760_c, entityplayermp);
            }
