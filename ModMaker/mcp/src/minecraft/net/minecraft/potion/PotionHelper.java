    ...
    private static int func_77912_a(String p_77912_0_, int p_77912_1_, int p_77912_2_, int p_77912_3_)
    {
        if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_)
        {
            ...
            if (l >= 0 && l < p_77912_2_)
            {
                ...
                {
                    j1 = func_77912_a(p_77912_0_, l + 1, p_77912_2_, p_77912_3_);
                    return j1 > 0 ? j1 : 0;
                }
            }
            else
            {
                ...
                {
                    j1 = func_77912_a(p_77912_0_, p_77912_1_, i1 - 1, p_77912_3_);
                    ...
                    {
                        int k1 = func_77912_a(p_77912_0_, i1 + 1, p_77912_2_, p_77912_3_);
                ...
                else
                {
                    ...
                    for (int k2 = p_77912_1_; k2 < p_77912_2_; ++k2)
                    {
                        ...
                        else if (c0 == 33)
                        {
                            if (flag2)
                            {
                                j2 += func_77904_a(flag3, flag1, flag4, b0, l1, i2, p_77912_3_);
                                flag3 = false;
                                flag4 = false;
                                flag = false;
                                flag1 = false;
