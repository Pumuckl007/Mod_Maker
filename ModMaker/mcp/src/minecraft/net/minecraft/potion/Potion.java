...
public class Potion
{
    ...
    public void func_111187_a(EntityLivingBase p_111187_1_, BaseAttributeMap p_111187_2_, int p_111187_3_)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            AttributeInstance attributeinstance = p_111187_2_.func_111151_a((Attribute)entry.getKey());
    ...
    public void func_111185_a(EntityLivingBase p_111185_1_, BaseAttributeMap p_111185_2_, int p_111185_3_)
    {
        ...
        {
            Entry entry = (Entry)iterator.next();
            AttributeInstance attributeinstance = p_111185_2_.func_111151_a((Attribute)entry.getKey());

            if (attributeinstance != null)
            {
                AttributeModifier attributemodifier = (AttributeModifier)entry.getValue();
                attributeinstance.func_111124_b(attributemodifier);
                attributeinstance.func_111121_a(new AttributeModifier(attributemodifier.func_111167_a(), this.func_76393_a() + " " + p_111185_3_, this.func_111183_a(p_111185_3_, attributemodifier), attributemodifier.func_111169_c()));
            }
        }
    }
