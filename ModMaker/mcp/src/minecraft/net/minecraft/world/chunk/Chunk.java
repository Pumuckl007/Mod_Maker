...
public class Chunk
{
    ...
    public Chunk(World p_i1996_1_, byte[] p_i1996_2_, int p_i1996_3_, int p_i1996_4_)
    {
        ...
        for (int l = 0; l < 16; ++l)
        {
            for (int i1 = 0; i1 < 16; ++i1)
            {
                ...
                {
                    byte b0 = p_i1996_2_[l << 11 | i1 << 7 | j1];
                    ...
                    if (b0 != 0)
                    {
                        ...
                        {
                            this.field_76652_q[k1] = new ExtendedBlockStorage(k1 << 4, !p_i1996_1_.field_73011_w.field_76576_e);
                        }
    ...
    public boolean func_76592_a(int p_76592_1_, int p_76592_2_, int p_76592_3_, int p_76592_4_, int p_76592_5_)
    {
        ...
        else
        {
            ...
            if (extendedblockstorage == null)
            {
                ...
                extendedblockstorage = this.field_76652_q[p_76592_2_ >> 4] = new ExtendedBlockStorage(p_76592_2_ >> 4 << 4, !this.field_76637_e.field_73011_w.field_76576_e);
                flag = p_76592_2_ >= k1;
            }
            ...
            if (l1 != 0)
            {
                ...
                else if (Block.field_71973_m[l1] instanceof ITileEntityProvider && l1 != p_76592_4_)
                {
            ...
            else
            {
                ...
                if (p_76592_4_ != 0)
                {
                    ...
                    if (Block.field_71973_m[p_76592_4_] instanceof ITileEntityProvider)
                    {
                        ...
                        if (tileentity == null)
                        {
                            tileentity = ((ITileEntityProvider)Block.field_71973_m[p_76592_4_]).func_72274_a(this.field_76637_e);
                ...
                else if (l1 > 0 && Block.field_71973_m[l1] instanceof ITileEntityProvider)
                {
                    tileentity = this.func_76597_e(p_76592_1_, p_76592_2_, p_76592_3_);
    ...
    public boolean func_76589_b(int p_76589_1_, int p_76589_2_, int p_76589_3_, int p_76589_4_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (j1 > 0 && Block.field_71973_m[j1] instanceof ITileEntityProvider)
                {
    ...
    public TileEntity func_76597_e(int p_76597_1_, int p_76597_2_, int p_76597_3_)
    {
        ...
        if (tileentity == null)
        {
            ...
            if (tileentity == null)
            {
                tileentity = ((ITileEntityProvider)Block.field_71973_m[l]).func_72274_a(this.field_76637_e);
