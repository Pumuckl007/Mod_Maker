...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public boolean func_75805_a(String p_75805_1_, IProgressUpdate p_75805_2_)
    {
        ...
        MinecraftServer.func_71276_C().func_98033_al().func_98233_a("Total conversion count is " + i);
        WorldInfo worldinfo = this.func_75803_c(p_75805_1_);
        Object object = null;

        if (worldinfo.func_76067_t() == WorldType.field_77138_c)
        {
            object = new WorldChunkManagerHell(BiomeGenBase.field_76772_c, 0.5F, 0.5F);
        }
        else
        {
        ...
        this.func_75813_a(new File(file2, "region"), arraylist1, new WorldChunkManagerHell(BiomeGenBase.field_76778_j, 1.0F, 0.0F), arraylist.size(), i, p_75805_2_);
        this.func_75813_a(new File(file3, "region"), arraylist2, new WorldChunkManagerHell(BiomeGenBase.field_76779_k, 0.5F, 0.0F), arraylist.size() + arraylist1.size(), i, p_75805_2_);
