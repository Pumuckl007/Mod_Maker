...
public class ComponentVillageHall extends ComponentVillage
{
    ...
    public static ComponentVillageHall func_74906_a(ComponentVillageStartPiece p_74906_0_, List p_74906_1_, Random p_74906_2_, int p_74906_3_, int p_74906_4_, int p_74906_5_, int p_74906_6_, int p_74906_7_)
    {
        ...
        return func_74895_a(structureboundingbox) && StructureComponent.func_74883_a(p_74906_1_, structureboundingbox) == null ? new ComponentVillageHall(p_74906_0_, p_74906_7_, p_74906_2_, structureboundingbox, p_74906_6_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        for (k = 0; k < 5; ++k)
        {
            for (l = 0; l < 9; ++l)
            {
                ...
                this.func_74870_b(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, l, -1, k, p_74875_3_);
            }
        }
