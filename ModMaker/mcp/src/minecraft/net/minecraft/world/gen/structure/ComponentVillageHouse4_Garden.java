...
public class ComponentVillageHouse4_Garden extends ComponentVillage
{
    ...
    public static ComponentVillageHouse4_Garden func_74912_a(ComponentVillageStartPiece p_74912_0_, List p_74912_1_, Random p_74912_2_, int p_74912_3_, int p_74912_4_, int p_74912_5_, int p_74912_6_, int p_74912_7_)
    {
        ...
        return StructureComponent.func_74883_a(p_74912_1_, structureboundingbox) != null ? null : new ComponentVillageHouse4_Garden(p_74912_0_, p_74912_7_, p_74912_2_, structureboundingbox, p_74912_6_);
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        if (this.field_74913_b)
        {
            ...
            this.func_74864_a(p_74875_1_, Block.field_72055_aF.field_71990_ca, i, 3, 1, 3, p_74875_3_);
            this.func_74864_a(p_74875_1_, Block.field_72055_aF.field_71990_ca, i, 3, 2, 3, p_74875_3_);
            this.func_74864_a(p_74875_1_, Block.field_72055_aF.field_71990_ca, i, 3, 3, 3, p_74875_3_);
            this.func_74864_a(p_74875_1_, Block.field_72055_aF.field_71990_ca, i, 3, 4, 3, p_74875_3_);
        }
        ...
        for (i = 0; i < 5; ++i)
        {
            for (int j = 0; j < 5; ++j)
            {
                ...
                this.func_74870_b(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, j, -1, i, p_74875_3_);
            }
        }
