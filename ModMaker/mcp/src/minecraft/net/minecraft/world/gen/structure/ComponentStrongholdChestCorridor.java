...
public class ComponentStrongholdChestCorridor extends ComponentStronghold
{
    ...
    public static ComponentStrongholdChestCorridor func_75000_a(List p_75000_0_, Random p_75000_1_, int p_75000_2_, int p_75000_3_, int p_75000_4_, int p_75000_5_, int p_75000_6_)
    {
        ...
        return func_74991_a(structureboundingbox) && StructureComponent.func_74883_a(p_75000_0_, structureboundingbox) == null ? new ComponentStrongholdChestCorridor(p_75000_6_, p_75000_1_, structureboundingbox, p_75000_5_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        else
        {
            ...
            for (i = 2; i <= 4; ++i)
            {
                this.func_74864_a(p_74875_1_, Block.field_72079_ak.field_71990_ca, 5, 2, 1, i, p_74875_3_);
            }
