...
public abstract class StructureStart
{
    ...
    public NBTTagCompound func_143021_a(int p_143021_1_, int p_143021_2_)
    {
        ...
        nbttagcompound.func_74782_a("BB", this.field_75074_b.func_143047_a("BB"));
    ...
    public void func_143020_a(World p_143020_1_, NBTTagCompound p_143020_2_)
    {
        ...
        NBTTagList nbttaglist = p_143020_2_.func_74761_m("Children");

        for (int i = 0; i < nbttaglist.func_74745_c(); ++i)
        {
            this.field_75075_a.add(MapGenStructureIO.func_143032_b((NBTTagCompound)nbttaglist.func_74743_b(i), p_143020_1_));
        }
    ...
    protected void func_75070_a(World p_75070_1_, Random p_75070_2_, int p_75070_3_, int p_75070_4_)
    {
        ...
        if (k > 1)
        {
            l = p_75070_3_ + p_75070_2_.nextInt(k);
        }
        else
        {
            l = p_75070_3_;
        ...
        {
            StructureComponent structurecomponent = (StructureComponent)iterator.next();
            structurecomponent.func_74874_b().func_78886_a(0, i1, 0);
        }
    }
