...
public class ComponentNetherBridgeThrone extends ComponentNetherBridgePiece
{
    ...
    public static ComponentNetherBridgeThrone func_74975_a(List p_74975_0_, Random p_74975_1_, int p_74975_2_, int p_74975_3_, int p_74975_4_, int p_74975_5_, int p_74975_6_)
    {
        ...
        return func_74964_a(structureboundingbox) && StructureComponent.func_74883_a(p_74975_0_, structureboundingbox) == null ? new ComponentNetherBridgeThrone(p_74975_6_, p_74975_1_, structureboundingbox, p_74975_5_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        if (!this.field_74976_a)
        {
            ...
            if (p_74875_3_.func_78890_b(j, i, k))
            {
                ...
                p_74875_1_.func_72832_d(j, i, k, Block.field_72065_as.field_71990_ca, 0, 2);
                TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)p_74875_1_.func_72796_p(j, i, k);
