...
public class ComponentVillageChurch extends ComponentVillage
{
    ...
    public static ComponentVillageChurch func_74919_a(ComponentVillageStartPiece p_74919_0_, List p_74919_1_, Random p_74919_2_, int p_74919_3_, int p_74919_4_, int p_74919_5_, int p_74919_6_, int p_74919_7_)
    {
        ...
        return func_74895_a(structureboundingbox) && StructureComponent.func_74883_a(p_74919_1_, structureboundingbox) == null ? new ComponentVillageChurch(p_74919_0_, p_74919_7_, p_74919_2_, structureboundingbox, p_74919_6_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        int i = this.func_74863_c(Block.field_72055_aF.field_71990_ca, 4);
        int j;

        for (j = 1; j <= 9; ++j)
        {
            this.func_74864_a(p_74875_1_, Block.field_72055_aF.field_71990_ca, i, 3, j, 3, p_74875_3_);
        }
        ...
        for (j = 0; j < 9; ++j)
        {
            for (int k = 0; k < 5; ++k)
            {
                ...
                this.func_74870_b(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, k, -1, j, p_74875_3_);
            }
        }
