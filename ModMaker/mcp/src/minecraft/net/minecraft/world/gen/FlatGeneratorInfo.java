...
public class FlatGeneratorInfo
{
    ...
    public static FlatGeneratorInfo func_82649_e()
    {
        ...
        flatgeneratorinfo.func_82650_c().add(new FlatLayerInfo(1, Block.field_71986_z.field_71990_ca));
        flatgeneratorinfo.func_82650_c().add(new FlatLayerInfo(2, Block.field_71979_v.field_71990_ca));
        flatgeneratorinfo.func_82650_c().add(new FlatLayerInfo(1, Block.field_71980_u.field_71990_ca));
        flatgeneratorinfo.func_82645_d();
        flatgeneratorinfo.func_82644_b().put("village", new HashMap());
        return flatgeneratorinfo;
    }
