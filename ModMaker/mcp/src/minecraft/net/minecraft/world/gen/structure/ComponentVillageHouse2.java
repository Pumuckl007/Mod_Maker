...
public class ComponentVillageHouse2 extends ComponentVillage
{
    ...
    public static ComponentVillageHouse2 func_74915_a(ComponentVillageStartPiece p_74915_0_, List p_74915_1_, Random p_74915_2_, int p_74915_3_, int p_74915_4_, int p_74915_5_, int p_74915_6_, int p_74915_7_)
    {
        ...
        return func_74895_a(structureboundingbox) && StructureComponent.func_74883_a(p_74915_1_, structureboundingbox) == null ? new ComponentVillageHouse2(p_74915_0_, p_74915_7_, p_74915_2_, structureboundingbox, p_74915_6_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        for (i = 6; i <= 8; ++i)
        {
            if (this.func_74866_a(p_74875_1_, i, 0, -1, p_74875_3_) == 0 && this.func_74866_a(p_74875_1_, i, -1, -1, p_74875_3_) != 0)
            {
                this.func_74864_a(p_74875_1_, Block.field_72057_aH.field_71990_ca, this.func_74863_c(Block.field_72057_aH.field_71990_ca, 3), i, 0, -1, p_74875_3_);
            }
        }
