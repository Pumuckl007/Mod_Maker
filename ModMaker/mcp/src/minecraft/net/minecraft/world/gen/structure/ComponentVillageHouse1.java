...
public class ComponentVillageHouse1 extends ComponentVillage
{
    ...
    public static ComponentVillageHouse1 func_74898_a(ComponentVillageStartPiece p_74898_0_, List p_74898_1_, Random p_74898_2_, int p_74898_3_, int p_74898_4_, int p_74898_5_, int p_74898_6_, int p_74898_7_)
    {
        ...
        return func_74895_a(structureboundingbox) && StructureComponent.func_74883_a(p_74898_1_, structureboundingbox) == null ? new ComponentVillageHouse1(p_74898_0_, p_74898_7_, p_74898_2_, structureboundingbox, p_74898_6_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        for (k = -1; k <= 2; ++k)
        {
            for (l = 0; l <= 8; ++l)
            {
                this.func_74864_a(p_74875_1_, Block.field_72063_at.field_71990_ca, i, l, 6 + k, k, p_74875_3_);
                this.func_74864_a(p_74875_1_, Block.field_72063_at.field_71990_ca, j, l, 6 + k, 5 - k, p_74875_3_);
            }
        }
        ...
        k = this.func_74863_c(Block.field_72063_at.field_71990_ca, 3);
        this.func_74864_a(p_74875_1_, Block.field_72063_at.field_71990_ca, k, 6, 1, 4, p_74875_3_);
        this.func_74864_a(p_74875_1_, Block.field_72063_at.field_71990_ca, k, 5, 1, 4, p_74875_3_);
        this.func_74864_a(p_74875_1_, Block.field_72063_at.field_71990_ca, k, 4, 1, 4, p_74875_3_);
        this.func_74864_a(p_74875_1_, Block.field_72063_at.field_71990_ca, k, 3, 1, 4, p_74875_3_);
        ...
        for (l = 0; l < 6; ++l)
        {
            for (int i1 = 0; i1 < 9; ++i1)
            {
                ...
                this.func_74870_b(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, i1, -1, l, p_74875_3_);
            }
        }
