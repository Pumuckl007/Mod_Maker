...
public class ComponentNetherBridgeCorridor4 extends ComponentNetherBridgePiece
{
    ...
    public void func_74861_a(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
    {
        ...
        this.func_74961_b((ComponentNetherBridgeStartPiece)p_74861_1_, p_74861_2_, p_74861_3_, 0, b0, p_74861_3_.nextInt(8) > 0);
        this.func_74965_c((ComponentNetherBridgeStartPiece)p_74861_1_, p_74861_2_, p_74861_3_, 0, b0, p_74861_3_.nextInt(8) > 0);
    }
    ...
    public static ComponentNetherBridgeCorridor4 func_74985_a(List p_74985_0_, Random p_74985_1_, int p_74985_2_, int p_74985_3_, int p_74985_4_, int p_74985_5_, int p_74985_6_)
    {
        ...
        return func_74964_a(structureboundingbox) && StructureComponent.func_74883_a(p_74985_0_, structureboundingbox) == null ? new ComponentNetherBridgeCorridor4(p_74985_6_, p_74985_1_, structureboundingbox, p_74985_5_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        for (int i = 0; i <= 5; ++i)
        {
            for (int j = 0; j <= 8; ++j)
            {
                this.func_74870_b(p_74875_1_, Block.field_72033_bA.field_71990_ca, 0, j, -1, i, p_74875_3_);
            }
        }
