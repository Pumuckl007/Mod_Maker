...
public class ChunkProviderFlat implements IChunkProvider
{
    ...
    public ChunkProviderFlat(World p_i2004_1_, long p_i2004_2_, boolean p_i2004_4_, String p_i2004_5_)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            {
                this.field_82700_c[j] = (byte)(flatlayerinfo.func_82659_b() & 255);
    ...
    public Chunk func_73154_d(int p_73154_1_, int p_73154_2_)
    {
        ...
        for (int k = 0; k < this.field_82700_c.length; ++k)
        {
            ...
            for (int i1 = 0; i1 < 16; ++i1)
            {
                ...
                {
                    extendedblockstorage.func_76655_a(i1, k & 15, j1, this.field_82700_c[k] & 255);
        ...
        while (iterator.hasNext())
        {
            ...
            mapgenstructure.func_75036_a(this, this.field_73163_a, p_73154_1_, p_73154_2_, (byte[])null);
        }
    ...
    public void func_73153_a(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (this.field_82703_i != null && !flag && this.field_73161_b.nextInt(4) == 0)
        {
            ...
            k1 = this.field_73161_b.nextInt(128);
            i2 = l + this.field_73161_b.nextInt(16) + 8;
            this.field_82703_i.func_76484_a(this.field_73163_a, this.field_73161_b, l1, k1, i2);
        }

        if (this.field_82701_j != null && !flag && this.field_73161_b.nextInt(8) == 0)
        {
            l1 = k + this.field_73161_b.nextInt(16) + 8;
            k1 = this.field_73161_b.nextInt(this.field_73161_b.nextInt(120) + 8);
            i2 = l + this.field_73161_b.nextInt(16) + 8;

            if (k1 < 63 || this.field_73161_b.nextInt(10) == 0)
            {
                this.field_82701_j.func_76484_a(this.field_73163_a, this.field_73161_b, l1, k1, i2);
            }
        }
        ...
        if (this.field_82702_h)
        {
            for (l1 = 0; l1 < 8; ++l1)
            {
                k1 = k + this.field_73161_b.nextInt(16) + 8;
                i2 = this.field_73161_b.nextInt(128);
                int j2 = l + this.field_73161_b.nextInt(16) + 8;
                (new WorldGenDungeons()).func_76484_a(this.field_73163_a, this.field_73161_b, k1, i2, j2);
            }
        }
    ...
    public void func_82695_e(int p_82695_1_, int p_82695_2_)
    {
        ...
        {
            MapGenStructure mapgenstructure = (MapGenStructure)iterator.next();
            mapgenstructure.func_75036_a(this, this.field_73163_a, p_82695_1_, p_82695_2_, (byte[])null);
        }
    }
}
