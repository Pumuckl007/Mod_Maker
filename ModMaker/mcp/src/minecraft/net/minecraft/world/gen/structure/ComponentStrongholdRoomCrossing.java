...
public class ComponentStrongholdRoomCrossing extends ComponentStronghold
{
    ...
    public static ComponentStrongholdRoomCrossing func_75012_a(List p_75012_0_, Random p_75012_1_, int p_75012_2_, int p_75012_3_, int p_75012_4_, int p_75012_5_, int p_75012_6_)
    {
        ...
        return func_74991_a(structureboundingbox) && StructureComponent.func_74883_a(p_75012_0_, structureboundingbox) == null ? new ComponentStrongholdRoomCrossing(p_75012_6_, p_75012_1_, structureboundingbox, p_75012_5_) : null;
    }
        ...
        else
        {
            ...
            switch (this.field_75013_b)
            {
                ...
                case 1:
                    for (i = 0; i < 5; ++i)
                    {
                        this.func_74864_a(p_74875_1_, Block.field_72007_bm.field_71990_ca, 0, 3, 1, 3 + i, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_72007_bm.field_71990_ca, 0, 7, 1, 3 + i, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_72007_bm.field_71990_ca, 0, 3 + i, 1, 3, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_72007_bm.field_71990_ca, 0, 3 + i, 1, 7, p_74875_3_);
                    }
                ...
                case 2:
                    for (i = 1; i <= 9; ++i)
                    {
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, 1, 3, i, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, 9, 3, i, p_74875_3_);
                    }

                    for (i = 1; i <= 9; ++i)
                    {
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, i, 3, 1, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, i, 3, 9, p_74875_3_);
                    }
                    ...
                    for (i = 1; i <= 3; ++i)
                    {
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, 4, i, 4, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, 6, i, 4, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, 4, i, 6, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71978_w.field_71990_ca, 0, 6, i, 6, p_74875_3_);
                    }
                    ...
                    for (i = 2; i <= 8; ++i)
                    {
                        this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 2, 3, i, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 3, 3, i, p_74875_3_);

                        if (i <= 3 || i >= 7)
                        {
                            this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 4, 3, i, p_74875_3_);
                            this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 5, 3, i, p_74875_3_);
                            this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 6, 3, i, p_74875_3_);
                        }

                        this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 7, 3, i, p_74875_3_);
                        this.func_74864_a(p_74875_1_, Block.field_71988_x.field_71990_ca, 0, 8, 3, i, p_74875_3_);
                    }
