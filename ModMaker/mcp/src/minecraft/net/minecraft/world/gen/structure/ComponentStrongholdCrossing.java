...
public class ComponentStrongholdCrossing extends ComponentStronghold
{
    ...
    public void func_74861_a(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
    {
        ...
        {
            this.func_74989_b((ComponentStrongholdStairs2)p_74861_1_, p_74861_2_, p_74861_3_, i, 1);
        }

        if (this.field_74997_c)
        {
            this.func_74989_b((ComponentStrongholdStairs2)p_74861_1_, p_74861_2_, p_74861_3_, j, 7);
        }

        if (this.field_74995_d)
        {
            this.func_74987_c((ComponentStrongholdStairs2)p_74861_1_, p_74861_2_, p_74861_3_, i, 1);
        }

        if (this.field_74999_h)
        {
            this.func_74987_c((ComponentStrongholdStairs2)p_74861_1_, p_74861_2_, p_74861_3_, j, 7);
        }
    }
    ...
    public static ComponentStrongholdCrossing func_74994_a(List p_74994_0_, Random p_74994_1_, int p_74994_2_, int p_74994_3_, int p_74994_4_, int p_74994_5_, int p_74994_6_)
    {
        ...
        return func_74991_a(structureboundingbox) && StructureComponent.func_74883_a(p_74994_0_, structureboundingbox) == null ? new ComponentStrongholdCrossing(p_74994_6_, p_74994_1_, structureboundingbox, p_74994_5_) : null;
    }
