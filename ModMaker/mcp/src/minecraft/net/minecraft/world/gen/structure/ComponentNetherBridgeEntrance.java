...
public class ComponentNetherBridgeEntrance extends ComponentNetherBridgePiece
{
    ...
    public static ComponentNetherBridgeEntrance func_74984_a(List p_74984_0_, Random p_74984_1_, int p_74984_2_, int p_74984_3_, int p_74984_4_, int p_74984_5_, int p_74984_6_)
    {
        ...
        return func_74964_a(structureboundingbox) && StructureComponent.func_74883_a(p_74984_0_, structureboundingbox) == null ? new ComponentNetherBridgeEntrance(p_74984_6_, p_74984_1_, structureboundingbox, p_74984_5_) : null;
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        for (i = 4; i <= 8; ++i)
        {
            for (j = 0; j <= 2; ++j)
            {
                ...
                this.func_74870_b(p_74875_1_, Block.field_72033_bA.field_71990_ca, 0, i, -1, 12 - j, p_74875_3_);
            }
        }
        ...
        for (i = 0; i <= 2; ++i)
        {
            ...
            {
                this.func_74870_b(p_74875_1_, Block.field_72033_bA.field_71990_ca, 0, i, -1, j, p_74875_3_);
                this.func_74870_b(p_74875_1_, Block.field_72033_bA.field_71990_ca, 0, 12 - i, -1, j, p_74875_3_);
            }
        }
        ...
        if (p_74875_3_.func_78890_b(i, j, k))
        {
            ...
            Block.field_71973_m[Block.field_71944_C.field_71990_ca].func_71847_b(p_74875_1_, i, j, k, p_74875_2_);
