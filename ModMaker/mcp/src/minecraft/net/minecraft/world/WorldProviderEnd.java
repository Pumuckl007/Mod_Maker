...
public class WorldProviderEnd extends WorldProvider
{
    ...
    public Vec3 func_76562_b(float p_76562_1_, float p_76562_2_)
    {
        ...
        f4 *= f2 * 0.0F + 0.15F;
        f5 *= f2 * 0.0F + 0.15F;
        return this.field_76579_a.func_82732_R().func_72345_a((double)f3, (double)f4, (double)f5);
    }
    ...
    {
        int k = this.field_76579_a.func_72922_b(p_76566_1_, p_76566_2_);
        return k == 0 ? false : Block.field_71973_m[k].field_72018_cp.func_76230_c();
    }
