...
public class PathNavigate
{
    ...
    private int func_75503_j()
    {
        if (this.field_75515_a.func_70090_H() && this.field_75517_m)
        {
            ...
            int j = this.field_75513_b.func_72798_a(MathHelper.func_76128_c(this.field_75515_a.field_70165_t), i, MathHelper.func_76128_c(this.field_75515_a.field_70161_v));
            int k = 0;

            do
            {
                if (j != Block.field_71942_A.field_71990_ca && j != Block.field_71943_B.field_71990_ca)
                {
                    return i;
                }

                ++i;
                j = this.field_75513_b.func_72798_a(MathHelper.func_76128_c(this.field_75515_a.field_70165_t), i, MathHelper.func_76128_c(this.field_75515_a.field_70161_v));
                ++k;
            }
            while (k <= 16);
        ...
        else
        {
            for (int i2 = k1; i2 < k1 + p_75483_4_; ++i2)
            {
                for (int j2 = l1; j2 < l1 + p_75483_6_; ++j2)
                {
                    ...
                    {
                        int k2 = this.field_75513_b.func_72798_a(i2, p_75483_2_ - 1, j2);
                        ...
                        Material material = Block.field_71973_m[k2].field_72018_cp;

                        if (material == Material.field_76244_g && !this.field_75515_a.func_70090_H())
                        {
                            return false;
                        }
        ...
        for (int k1 = p_75496_1_; k1 < p_75496_1_ + p_75496_4_; ++k1)
        {
            for (int l1 = p_75496_2_; l1 < p_75496_2_ + p_75496_5_; ++l1)
            {
                for (int i2 = p_75496_3_; i2 < p_75496_3_ + p_75496_6_; ++i2)
                {
                    ...
                    {
                        int j2 = this.field_75513_b.func_72798_a(k1, l1, i2);

                        if (j2 > 0 && !Block.field_71973_m[j2].func_71918_c(this.field_75513_b, k1, l1, i2))
                        {
                            return false;
                        }
                    }
