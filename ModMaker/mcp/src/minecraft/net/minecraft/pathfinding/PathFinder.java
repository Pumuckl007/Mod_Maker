...
public class PathFinder
{
    ...
    private PathEntity func_75857_a(Entity p_75857_1_, double p_75857_2_, double p_75857_4_, double p_75857_6_, float p_75857_8_)
    {
        ...
        if (this.field_75869_h && p_75857_1_.func_70090_H())
        {
            ...
            for (int j = this.field_75868_a.func_72798_a(MathHelper.func_76128_c(p_75857_1_.field_70165_t), i, MathHelper.func_76128_c(p_75857_1_.field_70161_v)); j == Block.field_71942_A.field_71990_ca || j == Block.field_71943_B.field_71990_ca; j = this.field_75868_a.func_72798_a(MathHelper.func_76128_c(p_75857_1_.field_70165_t), i, MathHelper.func_76128_c(p_75857_1_.field_70161_v)))
            {
                ++i;
            }
        ...
        PathPoint pathpoint = this.func_75854_a(MathHelper.func_76128_c(p_75857_1_.field_70121_D.field_72340_a), i, MathHelper.func_76128_c(p_75857_1_.field_70121_D.field_72339_c));
        PathPoint pathpoint1 = this.func_75854_a(MathHelper.func_76128_c(p_75857_2_ - (double)(p_75857_1_.field_70130_N / 2.0F)), MathHelper.func_76128_c(p_75857_4_), MathHelper.func_76128_c(p_75857_6_ - (double)(p_75857_1_.field_70130_N / 2.0F)));
        ...
        PathEntity pathentity = this.func_75861_a(p_75857_1_, pathpoint, pathpoint1, pathpoint2, p_75857_8_);
    ...
    public static int func_82565_a(Entity p_82565_0_, int p_82565_1_, int p_82565_2_, int p_82565_3_, PathPoint p_82565_4_, boolean p_82565_5_, boolean p_82565_6_, boolean p_82565_7_)
    {
        ...
        for (int l = p_82565_1_; l < p_82565_1_ + p_82565_4_.field_75839_a; ++l)
        {
            for (int i1 = p_82565_2_; i1 < p_82565_2_ + p_82565_4_.field_75837_b; ++i1)
            {
                ...
                {
                    int k1 = p_82565_0_.field_70170_p.func_72798_a(l, i1, j1);

                    if (k1 > 0)
                    {
                        if (k1 == Block.field_72005_bk.field_71990_ca)
                        {
                            flag3 = true;
                        }
                        else if (k1 != Block.field_71942_A.field_71990_ca && k1 != Block.field_71943_B.field_71990_ca)
                        {
                            if (!p_82565_7_ && k1 == Block.field_72054_aE.field_71990_ca)
                            {
                                return 0;
                            }
                        }
                        ...
                        int l1 = block.func_71857_b();

                        if (p_82565_0_.field_70170_p.func_85175_e(l, i1, j1) == 9)
                        {
                            int i2 = MathHelper.func_76128_c(p_82565_0_.field_70165_t);
                            int j2 = MathHelper.func_76128_c(p_82565_0_.field_70163_u);
                            int k2 = MathHelper.func_76128_c(p_82565_0_.field_70161_v);

                            if (p_82565_0_.field_70170_p.func_85175_e(i2, j2, k2) != 9 && p_82565_0_.field_70170_p.func_85175_e(i2, j2 - 1, k2) != 9)
                            {
                                return -3;
                            }
                        }
                        else if (!block.func_71918_c(p_82565_0_.field_70170_p, l, i1, j1) && (!p_82565_6_ || k1 != Block.field_72054_aE.field_71990_ca))
                        {
                            if (l1 == 11 || k1 == Block.field_71993_bv.field_71990_ca || l1 == 32)
                            {
                                return -3;
                            }
