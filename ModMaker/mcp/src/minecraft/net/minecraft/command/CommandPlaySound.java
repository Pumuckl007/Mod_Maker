    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        ...
        else
        {
            ...
            if (d7 > d6)
            {
                if (d5 <= 0.0D)
                {
                    throw new CommandException("commands.playsound.playerTooFar", new Object[] {entityplayermp.func_70023_ak()});
                }
                ...
                entityplayermp.field_71135_a.func_72567_b(new Packet62LevelSound(s, d12, d13, d14, (float)d5, (float)d4));
            }
            else
            {
                entityplayermp.field_71135_a.func_72567_b(new Packet62LevelSound(s, d0, d1, d2, (float)d3, (float)d4));
            }

            func_71522_a(p_71515_1_, "commands.playsound.success", new Object[] {s, entityplayermp.func_70023_ak()});
        }
    }
