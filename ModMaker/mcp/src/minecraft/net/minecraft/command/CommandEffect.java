    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        ...
        else
        {
            ...
            if (p_71515_2_[1].equals("clear"))
            {
                ...
                {
                    throw new CommandException("commands.effect.failure.notActive.all", new Object[] {entityplayermp.func_70023_ak()});
                }

                entityplayermp.func_70674_bp();
                func_71522_a(p_71515_1_, "commands.effect.success.removed.all", new Object[] {entityplayermp.func_70023_ak()});
            }
            else
            {
                ...
                if (k == 0)
                {
                    ...
                    {
                        throw new CommandException("commands.effect.failure.notActive", new Object[] {ChatMessageComponent.func_111077_e(Potion.field_76425_a[i].func_76393_a()), entityplayermp.func_70023_ak()});
                    }

                    entityplayermp.func_82170_o(i);
                    func_71522_a(p_71515_1_, "commands.effect.success.removed", new Object[] {ChatMessageComponent.func_111077_e(Potion.field_76425_a[i].func_76393_a()), entityplayermp.func_70023_ak()});
                }
                else
                {
                    PotionEffect potioneffect = new PotionEffect(i, j, l);
                    entityplayermp.func_70690_d(potioneffect);
                    func_71522_a(p_71515_1_, "commands.effect.success", new Object[] {ChatMessageComponent.func_111077_e(potioneffect.func_76453_d()), Integer.valueOf(i), Integer.valueOf(l), entityplayermp.func_70023_ak(), Integer.valueOf(k)});
                }
            }
        }
    }
