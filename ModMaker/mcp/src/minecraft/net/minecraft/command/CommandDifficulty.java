...
public class CommandDifficulty extends CommandBase
{
    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        ...
        {
            int i = this.func_82364_d(p_71515_1_, p_71515_2_[0]);
            MinecraftServer.func_71276_C().func_71226_c(i);
            func_71522_a(p_71515_1_, "commands.difficulty.success", new Object[] {ChatMessageComponent.func_111077_e(field_82365_a[i])});
        }
        else
        {
