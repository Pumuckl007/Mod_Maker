        ...
        else
        {
            ...
            if (flag)
            {
                if (flag1)
                {
                    ...
                    func_71522_a(p_71515_1_, "commands.xp.success.negative.levels", new Object[] {Integer.valueOf(i), entityplayermp.func_70023_ak()});
                }
                else
                {
                    entityplayermp.func_82242_a(i);
                    func_71522_a(p_71515_1_, "commands.xp.success.levels", new Object[] {Integer.valueOf(i), entityplayermp.func_70023_ak()});
                }
            }
            else
            {
                ...
                func_71522_a(p_71515_1_, "commands.xp.success", new Object[] {Integer.valueOf(i), entityplayermp.func_70023_ak()});
            }
        }
    }
