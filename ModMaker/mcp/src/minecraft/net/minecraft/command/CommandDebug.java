...
public class CommandDebug extends CommandBase
{
    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        if (p_71515_2_.length == 1)
        {
            ...
            if (p_71515_2_[0].equals("stop"))
            {
                ...
                long k = i - this.field_71551_a;
                int l = j - this.field_71550_b;
                this.func_71548_a(k, l);
                MinecraftServer.func_71276_C().field_71304_b.field_76327_a = false;
                func_71522_a(p_71515_1_, "commands.debug.stop", new Object[] {Float.valueOf((float)k / 1000.0F), Integer.valueOf(l)});
                return;
            }
        }
    ...
    private void func_71548_a(long p_71548_1_, int p_71548_3_)
    {
        ...
        {
            MinecraftServer.func_71276_C().func_98033_al().func_98234_c("Could not save profiler results to " + file1, throwable);
        }
    }
    ...
    private String func_71547_b(long p_71547_1_, int p_71547_3_)
    {
        ...
        stringbuilder.append("// This is approximately ").append(String.format("%.2f", new Object[] {Float.valueOf((float)p_71547_3_ / ((float)p_71547_1_ / 1000.0F))})).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");
    ...
    private void func_71546_a(int p_71546_1_, String p_71546_2_, StringBuilder p_71546_3_)
    {
        ...
        if (list != null && list.size() >= 3)
        {
            for (int j = 1; j < list.size(); ++j)
            {
                ...
                p_71546_3_.append(" - ");
                p_71546_3_.append(String.format("%.2f", new Object[] {Double.valueOf(profilerresult.field_76332_a)}));
                p_71546_3_.append("%/");
                p_71546_3_.append(String.format("%.2f", new Object[] {Double.valueOf(profilerresult.field_76330_b)}));
                p_71546_3_.append("%\n");
