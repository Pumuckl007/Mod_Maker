                ...
                else
                {
                    ...
                    if (itemstack.func_77942_o())
                    {
                        ...
                        if (nbttaglist != null)
                        {
                            ...
                            {
                                short short1 = ((NBTTagCompound)nbttaglist.func_74743_b(k)).func_74765_d("id");
                                ...
                                if (Enchantment.field_77331_b[short1] != null)
                                {
                                    ...
                                    {
                                        throw new CommandException("commands.enchant.cantCombine", new Object[] {enchantment.func_77316_c(j), enchantment1.func_77316_c(((NBTTagCompound)nbttaglist.func_74743_b(k)).func_74765_d("lvl"))});
                                    }
                                }
                            }
                        }
