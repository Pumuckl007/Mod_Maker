...
public class CommandHandler implements ICommandManager
{
    ...
    public int func_71556_a(ICommandSender p_71556_1_, String p_71556_2_)
    {
            ...
            if (icommand.func_71519_b(p_71556_1_))
            {
                if (i > -1)
                {
                    ...
                    for (int l = 0; l < k; ++l)
                    {
                        ...
                        astring[i] = entityplayermp.func_70023_ak();
                        ...
                        {
                            p_71556_1_.func_70006_a(ChatMessageComponent.func_111082_b(commandexception.getMessage(), commandexception.func_74844_a()).func_111059_a(EnumChatFormatting.RED));
                        }
                    }
        ...
        {
            p_71556_1_.func_70006_a(ChatMessageComponent.func_111082_b("commands.generic.usage", new Object[] {ChatMessageComponent.func_111082_b(wrongusageexception.getMessage(), wrongusageexception.func_74844_a())}).func_111059_a(EnumChatFormatting.RED));
        }
        catch (CommandException commandexception1)
        {
            p_71556_1_.func_70006_a(ChatMessageComponent.func_111082_b(commandexception1.getMessage(), commandexception1.func_74844_a()).func_111059_a(EnumChatFormatting.RED));
        }
