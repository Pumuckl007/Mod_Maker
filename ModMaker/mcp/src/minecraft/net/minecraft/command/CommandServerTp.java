        ...
        else
        {
            ...
            if (p_71515_2_.length != 3 && p_71515_2_.length != 4)
            {
                if (p_71515_2_.length == 1 || p_71515_2_.length == 2)
                {
                    ...
                    func_71522_a(p_71515_1_, "commands.tp.success", new Object[] {entityplayermp.func_70023_ak(), entityplayermp1.func_70023_ak()});
                }
            }
            else if (entityplayermp.field_70170_p != null)
            {
                ...
                func_71522_a(p_71515_1_, "commands.tp.success.coordinates", new Object[] {entityplayermp.func_70023_ak(), Double.valueOf(d0), Double.valueOf(d1), Double.valueOf(d2)});
            }
        }
    }
