...
public class CommandGameMode extends CommandBase
{
    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        if (p_71515_2_.length > 0)
        {
            ...
            ChatMessageComponent chatmessagecomponent = ChatMessageComponent.func_111077_e("gameMode." + enumgametype.func_77149_b());

            if (entityplayermp != p_71515_1_)
            {
                func_71524_a(p_71515_1_, 1, "commands.gamemode.success.other", new Object[] {entityplayermp.func_70023_ak(), chatmessagecomponent});
            }
            else
            {
                func_71524_a(p_71515_1_, 1, "commands.gamemode.success.self", new Object[] {chatmessagecomponent});
            }
        }
        else
        {
