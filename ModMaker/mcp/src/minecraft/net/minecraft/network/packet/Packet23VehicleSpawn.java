...
public class Packet23VehicleSpawn extends Packet
{
    ...
    public Packet23VehicleSpawn(Entity p_i1401_1_, int p_i1401_2_, int p_i1401_3_)
    {
        ...
        if (p_i1401_3_ > 0)
        {
            double d0 = p_i1401_1_.field_70159_w;
            double d1 = p_i1401_1_.field_70181_x;
            double d2 = p_i1401_1_.field_70179_y;
            double d3 = 3.9D;
            ...
            this.field_73523_e = (int)(d0 * 8000.0D);
            this.field_73520_f = (int)(d1 * 8000.0D);
            this.field_73521_g = (int)(d2 * 8000.0D);
        }
    }
