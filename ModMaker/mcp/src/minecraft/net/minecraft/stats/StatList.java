...
public class StatList
{
    ...
    public static void func_75918_d()
    {
        if (field_75931_G && field_75935_H)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                hashset.add(Integer.valueOf(itemstack.field_77993_c));
            }
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    String s = StatCollector.func_74837_a("stat.craftItem", new Object[] {Item.field_77698_e[integer.intValue()].func_77635_s()});
                    field_75928_D[integer.intValue()] = (new StatCrafting(16842752 + integer.intValue(), s, integer.intValue())).func_75971_g();
                }
            }
    ...
    private static StatBase[] func_75921_a(String p_75921_0_, int p_75921_1_)
    {
        ...
        for (int j = 0; j < 256; ++j)
        {
            if (Block.field_71973_m[j] != null && Block.field_71973_m[j].func_71876_u())
            {
                String s1 = StatCollector.func_74837_a(p_75921_0_, new Object[] {Block.field_71973_m[j].func_71931_t()});
                astatbase[j] = (new StatCrafting(p_75921_1_ + j, s1, j)).func_75971_g();
                field_75939_e.add((StatCrafting)astatbase[j]);
            }
        }
    ...
    private static StatBase[] func_75920_a(StatBase[] p_75920_0_, String p_75920_1_, int p_75920_2_, int p_75920_3_, int p_75920_4_)
    {
        ...
        for (int l = p_75920_3_; l < p_75920_4_; ++l)
        {
            if (Item.field_77698_e[l] != null)
            {
                String s1 = StatCollector.func_74837_a(p_75920_1_, new Object[] {Item.field_77698_e[l].func_77635_s()});
                p_75920_0_[l] = (new StatCrafting(p_75920_2_ + l, s1, l)).func_75971_g();

                if (l >= 256)
                {
                    field_75938_d.add((StatCrafting)p_75920_0_[l]);
                }
            }
        }
    ...
    private static StatBase[] func_75926_b(StatBase[] p_75926_0_, String p_75926_1_, int p_75926_2_, int p_75926_3_, int p_75926_4_)
    {
        ...
        for (int l = p_75926_3_; l < p_75926_4_; ++l)
        {
            if (Item.field_77698_e[l] != null && Item.field_77698_e[l].func_77645_m())
            {
                String s1 = StatCollector.func_74837_a(p_75926_1_, new Object[] {Item.field_77698_e[l].func_77635_s()});
                p_75926_0_[l] = (new StatCrafting(p_75926_2_ + l, s1, l)).func_75971_g();
            }
        }
